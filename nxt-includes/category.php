 ...
 *
 * It is also possible that it will return a nxt_Error object on failure. Check
...
function get_cat_name( $cat_id ) {
	...
	if ( ! $category || is_nxt_error( $category ) )
		return '';

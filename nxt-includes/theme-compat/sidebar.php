...
?>
	<div id="sidebar" role="complementary">
		...
		<ul role="navigation">
			<?php nxt_list_pages('title_li=<h2>' . __('Pages') . '</h2>' ); ?>

			<li><h2><?php _e('Archives'); ?></h2>
				<ul>
				<?php nxt_get_archives(array('type' => 'monthly')); ?>
				</ul>
			</li>

			<?php nxt_list_categories(array('show_count' => 1, 'title_li' => '<h2>' . __('Categories') . '</h2>')); ?>
		</ul>
		<ul>
			<?php /* If this is the frontpage */ if ( is_home() || is_page() ) { ?>
				<?php nxt_list_bookmarks(); ?>

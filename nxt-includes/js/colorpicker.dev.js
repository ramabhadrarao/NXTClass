...
getAnchorWindonxtosition(anchorname)
  Returns an Object() having .x and .y properties of the pixel coordinates
  of the upper-left corner of the anchor, relative to the WHOLE SCREEN.

NOTES:

1) For popping up separate browser windows, use getAnchorWindonxtosition. 
...
function getAnchorWindonxtosition(anchorname) {
...
function PopupWindow_getXYPosition(anchorname) {
	var coordinates;
	if (this.type == "WINDOW") {
		coordinates = getAnchorWindonxtosition(anchorname);
		}
	else {
...
function PopupWindow_setWindonxtroperties(props) {
	this.windonxtroperties = props;
	}
...
function PopupWindow_shonxtopup(anchorname) {
	...
	if (this.divName != null) {
		...
		if (this.popupWindow == null || this.popupWindow.closed) {
			...
			this.popupWindow = window.open(avoidAboutBlank?"":"about:blank","window_"+anchorname,this.windonxtroperties+",width="+this.width+",height="+this.height+",screenX="+this.x+",left="+this.x+",screenY="+this.y+",top="+this.y+"");
			}
		this.refresh();
		}
	}
...
function PopupWindow() {
	...
	this.contents = "";
	this.url="";
	this.windonxtroperties="toolbar=no,location=no,status=no,menubar=no,scrollbars=auto,resizable,alwaysRaised,dependent,titlebar=no";
	...
	this.setWindonxtroperties = PopupWindow_setWindonxtroperties;
	this.refresh = PopupWindow_refresh;
	this.shonxtopup = PopupWindow_shonxtopup;

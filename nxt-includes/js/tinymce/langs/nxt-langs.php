...
$lang = 'tinyMCE.addI18n({' . _nxt_Editors::$mce_locale . ':{
common:{
...
tinyMCE.addI18n("' . _nxt_Editors::$mce_locale . '.advanced",{
...
tinyMCE.addI18n("' . _nxt_Editors::$mce_locale . '.advanced_dlg",{
...
tinyMCE.addI18n("' . _nxt_Editors::$mce_locale . '.media_dlg",{
...
tinyMCE.addI18n("' . _nxt_Editors::$mce_locale . '.nxtclass",{
nxt_adv_desc:"' . mce_escape( __('Show/Hide Kitchen Sink (Alt + Shift + Z)') )  . '",
nxt_more_desc:"' . mce_escape( __('Insert More Tag (Alt + Shift + T)') ) . '",
nxt_page_desc:"' . mce_escape( __('Insert Page break (Alt + Shift + P)') ) . '",
nxt_help_desc:"' . mce_escape( __('Help (Alt + Shift + H)') ) . '",
nxt_more_alt:"' . mce_escape( __('More...') ) . '",
nxt_page_alt:"' . mce_escape( __('Next page...') ) . '",
...
tinyMCE.addI18n("' . _nxt_Editors::$mce_locale . '.nxteditimage",{

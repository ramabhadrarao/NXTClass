 ...
 * HTML.
 *
 * This function is used internally by nxt_list_bookmarks() and should not be
 * used by themes.
 *
 ...
 */
function nxt_list_bookmarks($args = '') {
	$defaults = array(
	...
	$output = apply_filters( 'nxt_list_bookmarks', $output );

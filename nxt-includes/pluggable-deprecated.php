<?php
/**
 * Deprecated pluggable functions from past NXTClass versions. You shouldn't use these
...
if ( !function_exists('nxt_setcookie') ) :
/**
...
function nxt_setcookie($username, $password = '', $already_md5 = false, $home = '', $siteurl = '', $remember = false) {
	...
	_deprecated_function( 'nxt_setcookie', '2.5', 'nxt_set_auth_cookie()' );
endif;

if ( !function_exists('nxt_clearcookie') ) :
/**
...
function nxt_clearcookie() {
	...
	_deprecated_function( 'nxt_clearcookie', '2.5', 'nxt_clear_auth_cookie()' );
endif;

if ( !function_exists('nxt_get_cookie_login') ):
/**
 * Gets the user cookie login. This function is deprecated.
 *
 * This function is deprecated and should no longer be extended as it won't be
 * used anywhere in NXTClass. Also, plugins shouldn't use it either.
 *
 * @since 2.0.3
 * @deprecated 2.5
 ...
 */
function nxt_get_cookie_login() {
	_deprecated_function( __FUNCTION__, '2.5' );
	return false;
}
else :
	_deprecated_function( 'nxt_get_cookie_login', '2.5' );
endif;

if ( !function_exists('nxt_login') ) :
/**
...
function nxt_login($username, $password, $deprecated = '') {
	...
	_deprecated_function( 'nxt_login', '2.5', 'nxt_signon()' );
endif;

...
jQuery(window).unload( function () { tinymce = tinyMCE = nxtgallery = null; } ); // Cleanup

/* gallery settings */
var tinymce = null, tinyMCE, nxtgallery;
...
nxtgallery = {
	...
	setup : function() {
		...
		if ( t.el.nodeName != 'IMG' || ! ed.dom.hasClass(t.el, 'nxtGallery') ) {
			if ( (g = ed.dom.select('img.nxtGallery')) && g[0] ) {
				t.el = g[0];
			} else {

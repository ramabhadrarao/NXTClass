...
function setUserSetting( name, value, del ) {
	...
	var c = 'nxt-settings-' + userSettings.uid, o = nxtCookies.getHash(c) || {}, d = new Date(), p,
	...
	nxtCookies.set('nxt-settings-time-'+userSettings.uid, userSettings.time, d, p);
...
function getAllUserSettings() {
	...
	return nxtCookies.getHash('nxt-settings-' + userSettings.uid) || {};
}

...
<h1><?php printf( __( 'Welcome to NXTClass %s' ), $display_version ); ?></h1>

<div class="about-text"><?php printf( __( 'Thank you for updating to the latest version! Using NXTClass %s will improve your looks, personality, and web publishing experience. Okay, just the last one, but still. :)' ), $display_version ); ?></div>
...
<div class="changelog point-releases">
	...
	<p><?php printf( _n( '<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bug.',
         '<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bugs.', 15 ), '1.1.0', number_format_i18n( 15 ) ); ?>
		<?php printf( __( 'For more information, see <a href="%s">the release notes</a>.' ), 'http://codex.opensource.nxtclass.tk/Version_1.1.0' ); ?>
 	</p>
</div>
...
<div class="changelog">
	...
	<div class="feature-section images-stagger-right">
		...
		<div class="left-feature">
			...
			<p><?php _e( 'When we add new features, move navigation, or do anything else with the dashboard that might throw you for a loop when you update your NXTClass site, we&#8217;ll let you know about it with new feature pointers explaining the change.' ); ?></p>

			<h4><?php _e( 'Post-update Changelog' ); ?></h4>
			<p><?php _e( 'This screen! From now on when you update NXTClass, you&#8217;ll be brought to this screen &mdash; also accessible any time from the W logo in the corner of the toolbar &mdash; to get an overview of what&#8217;s changed.' ); ?></p>

			<h4><?php _e( 'Dashboard Welcome' ); ?></h4>
			<p><?php _e( 'The dashboard home screen will have a Welcome area that displays when a new NXTClass installation is accessed for the first time, prompting the site owner to complete various setup tasks. Once dismissed, this welcome can be accessed via the dashboard home screen options tab.' ); ?></p>
		</div>
	</div>
...
<div class="changelog">
	...
	<div class="feature-section three-col">
		...
		<div>
			...
			<p><?php _e( 'Want to import content from Tumblr to NXTClass? No problem! Go to <span class="no-break">Tools &rarr; Import</span> to get the new Tumblr Importer, which maps your Tumblog posts to the matching NXTClass post formats. Tip: Choose a theme designed to display post formats to get the greatest benefit from the importer.' ); ?></p>
		</div>
...
<div class="changelog">
	...
	<div class="feature-section three-col">
		...
		<div class="last-feature">
			...
			<p><?php printf( __( 'NXTClass now includes the entire jQuery UI stack and the latest version of jQuery: %s.' ), '1.7.1' ); ?></p>
		</div>
	</div>
	...
	<div class="feature-section three-col">
		<div>
			...
			<p><?php _e( 'This handy method will tell you if a <code>nxt_Query</code> object is the main NXTClass query or a secondary query.' ); ?></p>
		</div>
		<div>
			<h4><?php _e( 'nxt_Screen API' ); ?></h4>
			<p><?php _e( 'NXTClass has a nice new API for working with admin screens. Create rich screens, add help documentation, adapt to screen contexts, and more.' ); ?></p>
		</div>
		<div class="last-feature">
...
/* translators: 1: NXTClass version number. */
_n_noop( '<strong>Version %1$s</strong> addressed a security issue.',
         '<strong>Version %1$s</strong> addressed some security issues.' );

/* translators: 1: NXTClass version number, 2: plural number of bugs. */
_n_noop( '<strong>Version %1$s</strong> addressed %2$s bug.',
         '<strong>Version %1$s</strong> addressed %2$s bugs.' );

/* translators: 1: NXTClass version number, 2: plural number of bugs. Singular security issue. */
_n_noop( '<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bug.',
         '<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bugs.' );

/* translators: 1: NXTClass version number, 2: plural number of bugs. More than one security issue. */

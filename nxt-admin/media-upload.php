...
nxt_enqueue_script('plupload-handlers');
nxt_enqueue_script('image-edit');
nxt_enqueue_script('set-post-thumbnail' );
...
if ( isset($_GET['inline']) ) {
	...
	if ( isset($_GET['upload-page-form']) ) {
		...
		nxt_redirect( admin_url($location) );
		exit;
	}
	...
	get_current_screen()->set_help_sidebar(
		...
		'<p>' . __('<a href="http://codex.opensource.nxtclass.tk/Media_Add_New_Screen" target="_blank">Documentation on Uploading Media Files</a>') . '</p>' .

...
if ( !empty($_REQUEST['ajax']) ) {
	...
	case 'photo_images':
		...
		$url = nxt_kses(urldecode($url), null);
...
?>
	...
	.rtl.press-this #nxthead h1 {
		float: right;
	}
	</style>
	<script type="text/javascript">
	var nxtActiveEditor = 'content';
...
<body class="press-this nxt-admin<?php if ( is_rtl() ) echo ' rtl'; ?>">
<form action="press-this.php?action=post" method="post">
<div id="poststuff" class="metabox-holder">
	<div id="side-sortables" class="press-this-sidebar">
		<div class="sleeve">
			<?php nxt_nonce_field('press-this') ?>
			...
			<div id="submitdiv" class="postbox">
				...
				<div class="inside">
					...
					<?php
						...
						<img src="<?php echo esc_url( admin_url( 'images/nxtspin_light.gif' ) ); ?>" alt="" id="saving" style="display:none;" />
					</p>
				...
				<div id="taxonomy-category" class="categorydiv">
					...
					<div id="category-pop" class="tabs-panel" style="display: none;">
						<ul id="categorychecklist-pop" class="categorychecklist form-no-clear" >
							<?php $popular_ids = nxt_popular_terms_checklist( 'category' ); ?>
						</ul>
					</div>

					<div id="category-all" class="tabs-panel">
						<ul id="categorychecklist" class="list:category categorychecklist form-no-clear">
							<?php nxt_terms_checklist($post_ID, array( 'taxonomy' => 'category', 'popular_cats' => $popular_ids ) ) ?>
						</ul>
					</div>
					...
					<?php if ( current_user_can($tax->cap->edit_terms) ) : ?>
						<div id="category-adder" class="nxt-hidden-children">
							...
							<p id="category-add" class="category-add nxt-hidden-child">
								...
								<?php nxt_dropdown_categories( array( 'taxonomy' => 'category', 'hide_empty' => 0, 'name' => 'newcategory_parent', 'orderby' => 'name', 'hierarchical' => 1, 'show_option_none' => '&mdash; ' . $tax->labels->parent_item . ' &mdash;', 'tab_index' => 3 ) ); ?>
								...
								<?php nxt_nonce_field( 'add-category', '_ajax_nonce-add-category', false ); ?>
	...
	<div class="posting">
		...
		<div id="waiting" style="display: none"><img src="<?php echo esc_url( admin_url( 'images/nxtspin_light.gif' ) ); ?>" alt="" /> <?php esc_html_e( 'Loading...' ); ?></div>
		...
		nxt_editor( $content, 'content', $editor_settings );

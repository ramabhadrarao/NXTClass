 ...
 * @access private
 */
class nxt_Links_List_Table extends nxt_List_Table {
	...
	function prepare_items() {
		...
		nxt_reset_vars( array( 'action', 'cat_id', 'linkurl', 'name', 'image', 'description', 'visible', 'target', 'category', 'link_id', 'submit', 'orderby', 'order', 'links_show_cat_id', 'rating', 'rel', 'notes', 'linkcheck[]', 's' ) );

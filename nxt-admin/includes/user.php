 ...
 * list of roles in the $nxt_roles object so that plugins can remove
 ...
 * @return object nxt_User object with user data.
 */
...
function get_users_drafts( $user_id ) {
	global $nxtdb;
	$query = $nxtdb->prepare("SELECT ID, post_title FROM $nxtdb->posts WHERE post_type = 'post' AND post_status = 'draft' AND post_author = %d ORDER BY post_modified DESC", $user_id);
	$query = apply_filters('get_users_drafts', $query);
	return $nxtdb->get_results( $query );
}

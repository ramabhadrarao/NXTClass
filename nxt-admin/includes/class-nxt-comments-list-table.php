 ...
 * @access private
 */
class nxt_Comments_List_Table extends nxt_List_Table {
...
<?php
		...
		if ( ( 'spam' == $comment_status || 'trash' == $comment_status ) && current_user_can( 'moderate_comments' ) ) {
			nxt_nonce_field( 'bulk-destroy', '_destroy_nonce' );
...
<?php
	...
	function single_row( $a_comment ) {
		...
		$comment = $a_comment;
		$the_comment_class = join( ' ', get_comment_class( nxt_get_comment_status( $comment->comment_ID ) ) );
 ...
 * @access private
 *
 * @see nxt_Comments_Table
 */
class nxt_Post_Comments_List_Table extends nxt_Comments_List_Table {

 ...
 * @access private
 */
class nxt_MS_Users_List_Table extends nxt_List_Table {
	...
	function prepare_items() {
		...
		$this->set_pagination_args( array(
			'total_items' => $nxt_user_search->get_total(),
	...
	function get_columns() {
		...
		$users_columns = apply_filters( 'nxtmu_users_columns', $users_columns );
				...
				switch ( $column_name ) {
					...
					case 'username':
						...
						if ( get_current_user_id() == $user->ID ) {
							...
							$edit_link = esc_url( network_admin_url( add_query_arg( 'nxt_http_referer', urlencode( stripslashes( $_SERVER['REQUEST_URI'] ) ), 'user-edit.php?user_id=' . $user->ID ) ) );
						}
						...
						echo "<td $attributes>"; ?>
							...
							<?php
								...
								if ( current_user_can( 'delete_user', $user->ID ) && ! in_array( $user->user_login, $super_admins ) ) {
									$actions['delete'] = '<a href="' . $delete = esc_url( network_admin_url( add_query_arg( '_nxt_http_referer', urlencode( stripslashes( $_SERVER['REQUEST_URI'] ) ), nxt_nonce_url( 'users.php', 'deleteuser' ) . '&amp;action=deleteuser&amp;id=' . $user->ID ) ) ) . '" class="delete">' . __( 'Delete' ) . '</a>';
								}

 ...
 * @access private
 */
class nxt_Theme_Install_List_Table extends nxt_List_Table {
	...
	function prepare_items() {
		include( ABSPATH . 'nxt-admin/includes/theme-install.php' );

		global $tabs, $tab, $paged, $type, $term, $theme_field_defaults;

		nxt_reset_vars( array( 'tab' ) );
		...
		if ( is_nxt_error( $api ) )
			nxt_die( $api->get_error_message() . '</p> <p><a href="#" onclick="document.location.reload(); return false;">' . __( 'Try again' ) . '</a>' );

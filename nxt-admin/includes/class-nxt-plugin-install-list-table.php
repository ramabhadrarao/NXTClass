 ...
 * @access private
 */
class nxt_Plugin_Install_List_Table extends nxt_List_Table {
	...
	function prepare_items() {
		include( ABSPATH . 'nxt-admin/includes/plugin-install.php' );
		...
		if ( is_nxt_error( $api ) )
			nxt_die( $api->get_error_message() . '</p> <p class="hide-if-no-js"><a href="#" onclick="document.location.reload(); return false;">' . __( 'Try again' ) . '</a>' );

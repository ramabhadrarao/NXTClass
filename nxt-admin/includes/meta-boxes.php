...
<p><?php _e('Excerpts are optional hand-crafted summaries of your content that can be used in your theme. <a href="http://codex.nxtclass.org/Excerpt" target="_blank">Learn more about manual excerpts.</a>'); ?></p>
<?php
}
...
<p><?php _e('Trackbacks are a way to notify legacy blog systems that you&#8217;ve linked to them. If you link other NXTClass sites they&#8217;ll be notified automatically using <a href="http://codex.nxtclass.org/Introduction_to_Blogging#Managing_Comments" target="_blank">pingbacks</a>, no other action necessary.'); ?></p>
<?php
if ( ! empty($pings) )
	echo $pings;
}
...
<p><?php _e('Custom fields can be used to add extra metadata to a post that you can <a href="http://codex.nxtclass.org/Using_Custom_Fields" target="_blank">use in your theme</a>.'); ?></p>
<?php
}
...
<p class="meta-options">
	...
	<label for="ping_status" class="selectit"><input name="ping_status" type="checkbox" id="ping_status" value="open" <?php checked($post->ping_status, 'open'); ?> /> <?php printf( __( 'Allow <a href="%s" target="_blank">trackbacks and pingbacks</a> on this page.' ), __( 'http://codex.nxtclass.org/Introduction_to_Blogging#Managing_Comments' ) ); ?></label>

...
if ( ! current_user_can('install_themes') )
	nxt_die( __( 'You do not have sufficient permissions to install themes on this site.' ) );

if ( is_multisite() && ! is_network_admin() ) {
	nxt_redirect( network_admin_url( 'theme-install.php' ) );
	exit();
}

$nxt_list_table = _get_list_table('nxt_Theme_Install_List_Table');
...
nxt_enqueue_script( 'theme-install' );

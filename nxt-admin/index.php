...
$help .= '<p>' . __('<strong>Right Now</strong> - Displays a summary of the content on your site and identifies which theme and version of NXTClass you are using.') . '</p>';
...
<?php require(ABSPATH . 'nxt-admin/admin-footer.php'); ?>

...
class Custom_Background {
	...
	function admin_load() {
		...
		get_current_screen()->set_help_sidebar(
			...
			'<p>' . __( '<a href="http://codex.opensource.nxtclass.tk/Appearance_Background_Screen" target="_blank">Documentation on Custom Background</a>' ) . '</p>' .
	...
	function take_action() {
		...
		if ( isset($_POST['reset-background']) ) {
			check_admin_referer('custom-background-reset', '_nxtnonce-custom-background-reset');
		...
		if ( isset($_POST['remove-background']) ) {
			...
			check_admin_referer('custom-background-remove', '_nxtnonce-custom-background-remove');
...
<?php nxt_nonce_field('custom-background-remove', '_nxtnonce-custom-background-remove'); ?>
...
<td>
<form method="post" action="">
<?php nxt_nonce_field('custom-background-reset', '_nxtnonce-custom-background-reset'); ?>
...
<?php nxt_nonce_field('custom-background-upload', '_nxtnonce-custom-background-upload') ?>
...
<?php nxt_nonce_field('custom-background'); ?>

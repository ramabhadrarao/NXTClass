...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __('<a href="http://codex.opensource.nxtclass.tk/Settings_Media_Screen" target="_blank">Documentation on Media Settings</a>') . '</p>' .
...
<span class="description"><?php _e('Default is <code>nxt-content/uploads</code>'); ?></span>
</td>
</tr>

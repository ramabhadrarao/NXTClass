...
$parent_file = 'index.php';
	...
	get_current_screen()->add_help_tab( array(
		...
		'title'   => __('Overview'),
		'content' =>
			'<p>' . __('Until NXTClass 3.0, running multiple sites required using NXTClass MU instead of regular NXTClass. In version 3.0, these applications have merged. If you are a former MU user, you should be aware of the following changes:') . '</p>' .

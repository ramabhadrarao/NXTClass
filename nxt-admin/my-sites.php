...
get_current_screen()->add_help_tab( array(
	...
	'content' =>
		...
		'<p>' . __('Up until NXTClass version 3.0, what is now called a Multisite Network had to be installed separately as NXTClass MU (multi-user).') . '</p>'
) );

get_current_screen()->set_help_sidebar(
	'<p><strong>' . __('For more information:') . '</strong></p>' .
	'<p>' . __('<a href="http://codex.opensource.nxtclass.tk/Dashboard_My_Sites_Screen" target="_blank">Documentation on My Sites</a>') . '</p>' .
...
<form id="myblogs" action="" method="post">
	...
	<?php nxt_nonce_field( 'update-my-sites' ); ?>
	<?php submit_button(); ?>
	</form>
<?php endif; ?>
	</div>

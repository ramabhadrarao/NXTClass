...
$menu[4] = array( '', 'read', 'separator1', '', 'nxt-menu-separator' );
...
$_nxt_last_object_menu = 25; // The index of the last top-level menu in the object menu group
...
foreach ( (array) get_post_types( array('show_ui' => true, '_builtin' => false, 'show_in_menu' => true ) ) as $ptype ) {
	...
	if ( $ptype_obj->show_in_menu !== true )
		continue;
	$ptype_menu_position = is_int( $ptype_obj->menu_position ) ? $ptype_obj->menu_position : ++$_nxt_last_object_menu; // If we're to use $_nxt_last_object_menu, increment it first.
...
$menu[59] = array( '', 'read', 'separator2', '', 'nxt-menu-separator' );
...
if ( current_user_can('list_users') ) {
	$_nxt_real_parent_file['profile.php'] = 'users.php'; // Back-compat for plugins adding submenus to profile.php.
	...
	$_nxt_real_parent_file['users.php'] = 'profile.php';
...
$menu[75] = array( __('Tools'), 'edit_posts', 'tools.php', '', 'menu-top menu-icon-tools', 'menu-tools', 'div' );
	...
	if ( ! is_multisite() && defined('nxt_ALLOW_MULTISITE') && nxt_ALLOW_MULTISITE )
...
$_nxt_last_utility_menu = 80; // The index of the last top-level menu in the utility menu group

$menu[99] = array( '', 'read', 'separator-last', '', 'nxt-menu-separator' );

// Back-compat for old top-levels
$_nxt_real_parent_file['post.php'] = 'edit.php';
$_nxt_real_parent_file['post-new.php'] = 'edit.php';
$_nxt_real_parent_file['edit-pages.php'] = 'edit.php?post_type=page';
$_nxt_real_parent_file['page-new.php'] = 'edit.php?post_type=page';
$_nxt_real_parent_file['nxtmu-admin.php'] = 'tools.php';
$_nxt_real_parent_file['ms-admin.php'] = 'tools.php';
...
require_once(ABSPATH . 'nxt-admin/includes/menu.php');

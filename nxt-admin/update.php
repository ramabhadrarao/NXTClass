...
include_once ABSPATH . 'nxt-admin/includes/class-nxt-upgrader.php';
...
if ( isset($_GET['action']) ) {
	...
	if ( 'update-selected' == $action ) {
		if ( ! current_user_can( 'update_plugins' ) )
			nxt_die( __( 'You do not have sufficient permissions to update plugins for this site.' ) );
		...
		if ( ! isset($_GET['failure']) && ! isset($_GET['success']) ) {
			nxt_redirect( admin_url('update.php?action=activate-plugin&failure=true&plugin=' . $plugin . '&_nxtnonce=' . $_GET['_nxtnonce']) );
			activate_plugin( $plugin, '', ! empty( $_GET['networkwide'] ), true );
			nxt_redirect( admin_url('update.php?action=activate-plugin&success=true&plugin=' . $plugin . '&_nxtnonce=' . $_GET['_nxtnonce']) );
			die();
		}
		...
		if ( ! current_user_can('install_plugins') )
			nxt_die(__('You do not have sufficient permissions to install plugins for this site.'));

		include_once ABSPATH . 'nxt-admin/includes/plugin-install.php'; //for plugins_api..
		...
		if ( ! current_user_can('update_themes') )
			nxt_die(__('You do not have sufficient permissions to update themes for this site.'));
		...
		if ( ! current_user_can('install_themes') )
			nxt_die(__('You do not have sufficient permissions to install themes for this site.'));

		include_once ABSPATH . 'nxt-admin/includes/theme-install.php'; //for themes_api..

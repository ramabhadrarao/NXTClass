...
Plugin URI: http://www.nxttheming.com
Description: A framework for building theme options.
Version: 0.8
Author: Devin Price
Author URI: http://www.nxttheming.com
License: GPLv2
*/
 ...
 *
 * Read more about the Settings API in the NXTClass codex:
 * http://codex.nxtclass.org/Settings_API
 *
 */
 ...
 * on a regular basis.
 *
 * http://codex.nxtclass.org/Function_Reference/add_option
 *
 */
...
function optionsframework_load_scripts() {
	...
	nxt_enqueue_script('color-picker', OPTIONS_FRAMEWORK_DIRECTORY.'js/colorpicker.js', array('jquery'));
	nxt_enqueue_script('options-custom', OPTIONS_FRAMEWORK_DIRECTORY.'js/options-custom.js', array('jquery'));
}
...
add_action( 'nxt_before_admin_bar_render', 'optionsframework_adminbar' );

...
function woo_tumblog_file_upload() {
	...
	$uploaded_file = nxt_handle_upload($filename, $override); // [file] [url] [type]
	...
	$wud = nxt_upload_dir(); // [path] [url] [subdir] [basedir] [baseurl] [error]
		...
		<div id="meta-fields" class="hide-fields">
			...
			<div id="additional-categories" style="width:<?php if (get_option( 'woo_tumblog_content_method') != 'post_format') { ?>47%;float:left;<?php } else { ?>94%;<?php } ?>">
				...
				<ul id="<?php echo $taxonomy; ?>checklist" class="list:<?php echo $taxonomy?> categorychecklist form-no-clear">
					<?php if ( function_exists( 'nxt_terms_checklist') ) { nxt_terms_checklist($post_id, array( 'taxonomy' => $taxonomy ) ); ?>
					<?php } else { nxt_category_checklist(); } ?>
				</ul>

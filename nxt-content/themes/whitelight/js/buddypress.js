...
jq(document).ready( function() {
	...
	jq("input#aw-whats-new-submit").click( function() {
		...
		jq.post( ajaxurl, {
			...
			'_nxtnonce_post_update': jq("input#_nxtnonce_post_update").val(),
			'content': content,
			'object': object,
			'item_id': item_id
		},
	...
	jq('div.activity').click( function(event) {
		...
		if ( target.hasClass('delete-activity') ) {
			...
			var nonce     = link_href.split('_nxtnonce=');
	...
	jq('div.activity').click( function(event) {
		...
		if ( target.attr('name') == 'ac_form_submit' ) {
			...
			jq.post( ajaxurl, {
				...
				'cookie': encodeURIComponent(document.cookie),
				'_nxtnonce_new_activity_comment': jq("input#_nxtnonce_new_activity_comment").val(),
	...
	jq("div#invite-list input").click( function() {
		...
		jq.post( ajaxurl, {
			...
			'cookie': encodeURIComponent(document.cookie),
			'_nxtnonce': jq("input#_nxtnonce_invite_uninvite_user").val(),
			'friend_id': friend_id,
	...
	jq("input#send_reply_button").click(
		function() {
			...
			jq.post( ajaxurl, {
				...
				'cookie': encodeURIComponent(document.cookie),
				'_nxtnonce': jq("input#send_message_nonce").val(),
	...
	/* Admin Bar & nxt_list_pages Javascript IE6 hover class */
	jq("#nxt-admin-bar ul.main-nav li, #nav li").mouseover( function() {
		jq(this).addClass('sfhover');
	});

	jq("#nxt-admin-bar ul.main-nav li, #nav li").mouseout( function() {
...
function bp_activity_request(scope, filter) {
	...
	bp_ajax_request = jq.post( ajaxurl, {
		...
		'cookie': encodeURIComponent(document.cookie),
		'_nxtnonce_activity_filter': jq("input#_nxtnonce_activity_filter").val(),
		'scope': scope,
		'filter': filter
	},
	function(response)

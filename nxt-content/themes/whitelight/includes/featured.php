 ...
 * Homepage Slider
 */
	global $nxt_query, $post, $panel_error_message;
...
<?php } else { ?>
	<div class="col-full"><?php echo do_shortcode('[box type="info"]Please add some slides in the NXTClass admin backend to show in the Featured Slider.[/box]'); ?></div>
<?php } ?> 

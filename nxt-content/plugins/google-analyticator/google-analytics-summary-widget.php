...
class GoogleAnalyticsSummary
{
	...
	{
		add_action('nxt_dashboard_setup', array($this, 'addDashboardWidget'));
		add_action('admin_print_scripts-index.php', array($this, 'addJavascript'));
		add_action('admin_head-index.php', array($this, 'addTopJs'));
		add_action('nxt_ajax_ga_stats_widget', array($this, 'ajaxWidget'));
	}
	...
	function addJavascript()
	{
		...
		nxt_enqueue_script('jquery-sparklines', plugins_url('/google-analyticator/jquery.sparkline.min.js'), array('jquery'), '1.5.1');
	}
			...
			jQuery(document).ready(function(){
				...
				jQuery.ajax({
					...
					data: {
						...
						_ajax_nonce: '<?php echo nxt_create_nonce("google-analyticator-statsWidget_get"); ?>'
					},

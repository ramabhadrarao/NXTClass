 ...
 *
 * Now using widget API available in NXTClass 2.8
 * @author Spiral Web Consulting
 **/
class GoogleStatsWidget extends nxt_Widget
{
	function GoogleStatsWidget() {
		...
		$this->nxt_Widget('googlestats', __('Google Analytics Stats', 'google-analyticator'), $widget_ops, $control_ops);
	}

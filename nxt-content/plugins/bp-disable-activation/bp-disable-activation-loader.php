...
Description:Disables the requirement for users to activate by email on a standalone nxt install with BuddyPress
Version: 0.4
Requires at least: BuddyPress 1.2.3
Tested up to: BuddyPress 1.2.3+nxt 2.9.2
Site Wide Only: true

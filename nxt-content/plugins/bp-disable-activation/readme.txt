...
Tags: BuddyPress, activation, nxtMU
Requires at least: 2.9.2
Tested up to: 2.9.2
Site Wide Only: true
Stable tag: .4

Disables the activation email and automatically activates new users in BuddyPress under a standard nxt install and nxtMU (multisite).  Also, automatically logs in the new user since the account is already active.
...
Known Bugs:
-Doesn't do the automatic login if you allow blog creation during the user creation in nxtMU (multisite)

== Installation ==

1. Upload the 'bp-disable-activation' folder to the `/nxt-content/plugins/` directory
...
= 0.4 =
* Made plugin sitewide for nxtMU
* Fixed nxtMU Activity Stream Addition
* Added Activity Stream New Member notation for nxt

= 0.3 =
* Added support for nxtMU (multisite).  Includes automatic activation, disabling activation email and automatic login

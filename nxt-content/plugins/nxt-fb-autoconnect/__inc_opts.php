...
$jfb_name       = "nxt-FB AutoConnect";
$jfb_version    = "2.3.0";
$jfb_homepage   = "http://www.justin-klein.com/projects/nxt-fb-autoconnect";
...
global $opt_jfb_bp_avatars, $opt_jfb_nxt_avatars, $opt_jfb_fulllogerr, $opt_jfb_disablenonce, $opt_jfb_show_credit;
...
$opt_jfb_nxt_avatars = "jfb_nxt_avatars";
...
//I'll log the components used to generate the nonce (see nxt_create_nonce()).  Then if the check fails,

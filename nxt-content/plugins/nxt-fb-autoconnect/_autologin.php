 ...
 * to login before navigating to the content, we can use nxt-FB-AutoConnet to handle it all automatically.
 ...
 * RewriteRule ^autologin[/]?([0-9]*)$ /nxtclass/nxt-content/plugins/nxt-fb-autoconnect/_autologin.php?p=$1 [R,L] 
...
//NOTE: This assumes that nxt_Query is filtered not to return posts which are inaccessible

<?php
/*
Description:  qTranslate Support for Google XML Sitemaps Generator for NXTClass
...
with qTranslate Support for NXTClass, v3.1.6.3" by NeoEGM and "Google XML
Sitemaps Generator for NXTClass, v3.1.6" by Arne Brachhold.

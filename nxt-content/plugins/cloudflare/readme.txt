...
The CloudFlare NXTClass Plugin ensures your NXTClass blog is running optimally on the CloudFlare platform.
...
* Better protection as spammers from your NXTClass blog get reported to CloudFlare
...
* We recommend that any user on NXTClass and CloudFlare should use this plugin. 
...
[Read more](http://blog.cloudflare.com/introducing-the-cloudflare-nxtclass-plugin) on why we created this plugin.

 ...
 */
function add_openid_to_comment_form(nxt_url, nonce) {
	...
	/**
	 * Make AJAX call to NXTClass to check if the given URL is a valid OpenID.
	...
	function check_openid( url ) {
		...
		jQuery.getJSON(nxt_url + '?openid=ajax', {url: url.val(), _nxtnonce: openid_nonce}, function(data, textStatus) {

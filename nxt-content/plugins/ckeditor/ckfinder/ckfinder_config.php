...
require_once(dirname(__FILE__). '/../../../../nxt-config.php');
...
function CheckAuthentication()
{
	...
	return $ckeditor_nxtclass->file_browser == 'ckfinder' && current_user_can('ckeditor_ckfinder_access');
}
...
$config['LicenseName'] = !empty($ckeditor_nxtclass->options['ckfinder']['license_name']) ? $ckeditor_nxtclass->options['ckfinder']['license_name'] : '';
$config['LicenseKey'] = !empty($ckeditor_nxtclass->options['ckfinder']['license_key']) ? $ckeditor_nxtclass->options['ckfinder']['license_key'] : '';
...
*/
$baseUrl = $ckeditor_nxtclass->user_files_url;
...
ATTENTION: The trailing slash is required.
*/
$baseDir = $ckeditor_nxtclass->user_files_absolute_path;
...
$config['Thumbnails'] = Array(
		...
		'enabled' => $ckeditor_nxtclass->options['ckfinder']['thumbnails_enabled'] == 't' ? true : false,
		'directAccess' => $ckeditor_nxtclass->options['ckfinder']['thumbnails_direct_access'] == 't' ? true : false,
		'maxWidth' => $ckeditor_nxtclass->options['ckfinder']['thumbnails_width'],
		'maxHeight' => $ckeditor_nxtclass->options['ckfinder']['thumbnails_height'],
		'bmpSupported' => false,
		'quality' => $ckeditor_nxtclass->options['ckfinder']['thumbnails_quality']);
...
*/
$config['Images'] = Array(
		'maxWidth' => $ckeditor_nxtclass->options['ckfinder']['images_width'],
		'maxHeight' => $ckeditor_nxtclass->options['ckfinder']['images_height'],
		'quality' => $ckeditor_nxtclass->options['ckfinder']['images_quality']);
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => $ckeditor_nxtclass->options['ckfinder']['file_max_size'],
		'allowedExtensions' => $ckeditor_nxtclass->options['upload']['files_allowed_ext'],
		'deniedExtensions' => '');
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => $ckeditor_nxtclass->options['ckfinder']['file_max_size'],
		'allowedExtensions' => $ckeditor_nxtclass->options['upload']['images_allowed_ext'],
		'deniedExtensions' => '');
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => $ckeditor_nxtclass->options['ckfinder']['file_max_size'],
		'allowedExtensions' => $ckeditor_nxtclass->options['upload']['flash_allowed_ext'],
		'deniedExtensions' => '');

<div class="wrap">
	...
	<h2><?php _e('CKEditor - configuration files', 'ckeditor_nxtclass') ?></h2>
	...
	<form method="post" name="template" id="template">
		<?php nxt_nonce_field('ckeditor_create_nonce_file_editor','csrf_ckeditor-for-nxtclass'); ?>
		<input type="hidden" name="file" value="<?php echo $file ?>" />
		<h3><?php _e('Browsing ', 'ckeditor_nxtclass') ?>: <i><?php echo $file ?></i></h3>
		<table class="form-table">
			<tr valign="top">
				<td>

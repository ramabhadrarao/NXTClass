...
<legend><?php _e("Shortcode", "gd-star-rating"); ?></legend>
    <table border="0" cellpadding="3" cellspacing="0" width="100%">
      <tr>
        <td class="gdsrright">
            <label>
                <select onchange="gdsrChangeShortcode('tinymce', <?php echo $nxtv; ?>)" id="srShortcode" name="srShortcode" style="width: 200px">

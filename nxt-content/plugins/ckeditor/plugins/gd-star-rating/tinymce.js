function gdsrChangeShortcode(calledfrom, nxtversion) {
    var tabber = "#gdsr_tabs";
    if (nxtversion < 28) tabber = tabber + " > ul";
...
function insertStarRatingCode() {
    ...
    if (shortcode == 'blograting') {
        ...
        funa = new Array();
        funtext = "nxt_gdsr_render_blog_rating_widget(array(";
        ...
        if (document.getElementById('srRVnxtostID').value > 0) tagtext = tagtext + " post=" + document.getElementById('srRVnxtostID').value;
        funtext = "nxt_gdsr_render_review(" + document.getElementById('srRVnxtostID').value + ", ";
        ...
        funtext = "nxt_gdsr_render_comment_aggregation(0, " + document.getElementById('srTemplateCAR').value;
        ...
        funtext = "nxt_gdsr_render_article(" + document.getElementById('srRatingBlockTemplate').value + ", ";
        ...
        funtext = "nxt_gdsr_render_article_thumbs(" + document.getElementById('srThumbsTemplate').value;
        ...
        funtext = "nxt_gdsr_show_multi_review(" + document.getElementById('srMultiReviewSet').value;
        funtext = funtext + ", " + document.getElementById('srTemplateRMB').value;
        funtext = funtext + ", " + document.getElementById('srMultiRevienxtostID').value;
        tagtext = tagtext + document.getElementById('srMultiReviewSet').value;
        if (document.getElementById('srMultiRevienxtostID').value > 0) tagtext = tagtext + " post=" + document.getElementById('srMultiRevienxtostID').value;
        ...
        funtext = "nxt_gdsr_render_multi(" + document.getElementById('srMultiRatingSet').value;
        ...
        tagtext = "[starrating";
        funtext = "nxt_gdsr_render_rating_results(array(";
        funa = new Array();

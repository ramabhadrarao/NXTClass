...
if ( !is_user_logged_in() || !current_user_can('edit_posts') )
  nxt_die(__("You are not allowed to be here"));
...
<head>
  ...
  <script language="javascript" type="text/javascript" src="<?php echo get_option('siteurl') ?>/nxt-includes/js/tinymce/utils/mctabs.js"></script>
  <script language="javascript" type="text/javascript" src="<?php echo CKEDITOR_PLUGIN_URL ?>plugins/nggallery/tinymce.js"></script>
  <link rel="stylesheet" href="<?php echo get_option('siteurl') ?>/nxt-includes/js/tinymce/themes/advanced/skins/nxt_theme/dialog.css?ver=327-1235100-vvq6.2.14line3" />
  <base target="_self" />
</head>
<body id="link">
<!-- <form onsubmit="insertLink();return false;" action="#"> -->
  ...
  <div class="panel_wrapper">
    ...
    <table border="0" cellpadding="4" cellspacing="0">
        ...
        <?php
          $albumlist = $nxtdb->get_results("SELECT * FROM $nxtdb->nggalbum ORDER BY id DESC");
    ...
    <table border="0" cellpadding="4" cellspacing="0">
        ...
        <?php
          $picturelist = $nxtdb->get_results("SELECT * FROM $nxtdb->nggpictures ORDER BY pid DESC");

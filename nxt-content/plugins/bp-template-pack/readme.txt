...
Requires at least: NXTClass 3.0 / BuddyPress 1.2
Tested up to: NXTClass 3.2.1 / BuddyPress 1.5
Stable tag: 1.2

== Description ==

Add support for BuddyPress to your existing NXTClass theme. This plugin will guide you through the process
step by step. Once you are finished, your existing NXTClass theme will be able to manage and display all BuddyPress
pages and content. The process is completely reversible and does not modify any of your existing template files.

== Installation ==

Download and install the plugin using the built in NXTClass plugin installer.
If you download the plugin manually, upload the plugin to "/nxt-content/plugins/bp-template-pack/".

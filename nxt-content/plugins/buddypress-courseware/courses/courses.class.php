...
class BPSP_Courses {
    ...
    function register_post_types() {
        ...
        if( !register_post_type( 'course', $course_post_def ) )
            nxt_die( __( 'BuddyPress Courseware error while registering courses post type.', 'bpsp' ) );
        ...
        if( !get_taxonomy( 'group_id' ) )
            nxt_die( __( 'BuddyPress Courseware error while registering group taxonomy.', 'bpsp' ) );
    }
    ...
    function init_course( $group_id ) {
        global $bp;
        $new_course_id =  nxt_insert_post( array(
        ...
        if( isset( $_POST['course'] ) && $_POST['course']['object'] == 'group' && isset( $_POST['_nxtnonce'] ) ) {
            ...
            if( true != $is_nonce )
                ...
                if( isset( $updated_course['title'] ) &&
                    ...
                    $updated_course_id =  nxt_update_post( array(
                        'ID'            => $old_course->ID,

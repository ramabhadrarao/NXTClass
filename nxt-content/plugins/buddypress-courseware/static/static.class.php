...
class BPSP_Static {
    ...
    function courseware_editor_enqueues() {
        nxt_enqueue_script( 'courseware-editor' );
        nxt_enqueue_style( 'courseware-editor' );
    }
    ...
    function load_courseware_css() {
        ...
        if( file_exists( STYLESHEETPATH . $css_name ) ) {
            ...
            nxt_enqueue_style( 'custom-courseware-css', $web_uri . $css_name, null, BPSP_VERSION );
        }
    }
    
    function bibs_enqueues() {
        nxt_enqueue_script( 'bibliography' );
        nxt_enqueue_style( 'flexselect' );
        nxt_enqueue_style( 'datatables' );
    }
    
    function lectures_enqueues() {
        nxt_enqueue_script( 'lectures' );
    }
    
    function edit_assignment_enqueues() {
        nxt_enqueue_script( 'edit-assignment' );
        nxt_enqueue_style( 'formbuilder' );
    }
    
    function new_assignment_enqueues() {
        nxt_enqueue_script( 'new-assignment' );
        nxt_enqueue_style( 'formbuilder' );
    }
    
    function new_bib_enqueues() {
        nxt_enqueue_script( 'new-bibliograpy' );
    }
    
    function edit_bib_enqueues() {
        nxt_enqueue_script( 'edit-bibliograpy' );
    }
    
    function gradebook_enqueues() {
        nxt_enqueue_script( 'gradebook' );
        nxt_enqueue_style( 'datatables' );
    }
    
    function schedules_enqueues() {
        nxt_enqueue_style( 'datetimepicker' );
        nxt_enqueue_script( 'schedules' );
    }   

    function list_assignments_enqueues() {
        nxt_enqueue_script( 'list-assignments' );
        nxt_enqueue_style( 'datatables' );
    }
    
    function assignment_enqueues() {
        nxt_enqueue_script( 'single-assignment' );
    }
    
    function list_schedules_enqueues() {
        nxt_enqueue_style( 'fullcalendar' );
        nxt_enqueue_style( 'datatables' );
        nxt_enqueue_script( 'list-schedules' );
    }

    function delete_schedule_enqueues() {
        nxt_enqueue_style( 'datatables' );
        nxt_enqueue_script( 'delete-schedule' );
        nxt_enqueue_style( 'datatables' );
    }
    
    function group_dashboard_enqueues() {
        nxt_enqueue_script( 'group-dashboard' );
    }

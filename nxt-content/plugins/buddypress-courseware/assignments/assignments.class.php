...
class BPSP_Assignments {
        ...
        if( isset( $_POST['assignment'] ) &&
            ...
            if( true != $is_nonce ) 
                ...
                if( isset( $new_assignment['title'] ) &&
                    ...
                    $new_assignment_id =  nxt_insert_post( array(
                    ...
                    if( $new_assignment_id ) {
                        nxt_set_post_terms( $new_assignment_id, $new_assignment['group_id'], 'group_id' );
                        nxt_set_post_terms( $new_assignment_id, $new_assignment['course_id'], 'course_id' );
    ...
    function single_assignment_screen( $vars ) {
        ...
        if( bp_group_is_forum_enabled() ) {
            ...
            $vars['assignment_e_forum_nonce'] = nxt_nonce_field( $e_forum_nonce, '_nxtnonce', true, false );
        }
    ...
    function enable_forum_assignment_screen( $vars ) {
        ...
        if( isset( $_POST['_nxtnonce'] ) )
            $is_nonce = nxt_verify_nonce( $_POST['_nxtnonce'], $e_forum_nonce );
        ...
        if( isset( $_POST['assignment'] ) &&
            ...
            if( true != $is_nonce )
                ...
                if( isset( $updated_assignment['title'] ) &&
                    ...
                    $updated_assignment_id =  nxt_update_post( array(

...
Requires at least: NXTClass 3.2, BuddyPress 1.5
Tested up to: NXTClass 3.3 / BuddyPress 1.6
Stable tag: 0.9.5
...
Please follow the [standard installation procedure for NXTClass plugins](http://codex.nxtclass.org/Managing_Plugins#Installing_Plugins).
...
= 0.9.4 =
* NXTClass 3.3 BuddyPress 1.5(six-ish) compatibility
* Fixed dashboard date/time issue
* Fixed a some warnings, code cleanups 
* Switched to `nxt_editor()`
...
* X-mas release! Happy past birthday to the NXTClass core guys and galz!
...
* Fixed the user search according to nxt 3.1 changes. Closes [#37](https://github.com/scholarpress/buddypress-courseware/issues/issue/37)

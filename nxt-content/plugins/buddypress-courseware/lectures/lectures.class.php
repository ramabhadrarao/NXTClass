   ...
   /**
        ...
        if( isset( $_POST['lecture'] ) && $_POST['lecture']['object'] == 'group' && isset( $_POST['_nxtnonce'] ) ) {
            ...
            if( true != $is_nonce ) 
                ...
                if( isset( $new_lecture['title'] ) &&
                    ...
                    $new_lecture_id =  nxt_insert_post( array(
    ...
    function single_lecture_screen( $vars ) {
        ...
        if( isset( $_GET['_nxtnonce'] ) )
            $is_nonce = nxt_verify_nonce( $_GET['_nxtnonce'], 'bookmark' );
        ...
        $vars['lecture_bookmark_uri'] = add_query_arg( '_nxtnonce', nxt_create_nonce( 'bookmark' ), $this->current_lecture->permalink );
        ...
        if( isset( $_POST['lecture'] ) &&
            ...
            if( true != $is_nonce )
                ...
                if( isset( $updated_lecture['title'] ) &&
                    ...
                    $updated_lecture_id =  nxt_update_post( array(
                        'ID'            => $old_lecture->ID,
    ...
    function next_lecture( $lecture ) {
        ...
        // Use NXTClass's hierarchical algorithm
     ...
     *
     * @param String $permalink, the NXTClass generated guid
     * @param Mixed $lecture, NXTClass post object
     ...
     * @param Mixed $lecture, the NXTClass object

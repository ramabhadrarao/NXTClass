...
if (!class_exists('W3_Db_Driver')) {
    require_once ABSPATH . 'nxt-includes/nxt-db.php';

    class W3_Db_Driver extends nxtdb {
    }
}
...
class W3_Db extends W3_Db_Driver {
    ...
    */
    ...
    /**
     * Returns onject instance. Called by nxt engine
     *
     * @return W3_Db
     */
    function &instance() {

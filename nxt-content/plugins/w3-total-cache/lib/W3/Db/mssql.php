...
/**
 * NXTClass Database Access Abstraction Object
 *
 * It is possible to replace this class with your own
 * by setting the $nxtdb global variable in nxt-content/db.php
 * file with your class. You can name it nxtdb also, since
...
class W3_Db_Driver extends SQL_Translations {
        ...
        /**
         * NXTClass table prefix
         *
         * You can set this to have multiple NXTClass installations
        ...
        /**
         * List of NXTClass per-blog tables
         *
         * @since 2.5.0
         * @access private
         * @see nxtdb::tables()
        ...
        /**
         * List of deprecated NXTClass tables
         *
        ...
        /**
         * List of NXTClass global tables
         *
         * @since 3.0.0
         * @access private
         * @see nxtdb::tables()
        ...
        /**
         * NXTClass Comment Metadata table
         *
         * @since 2.9.0
         * @access public
         * @var string
        ...
        /**
         * NXTClass Term Relationships table
         *
         * @since 2.3.0
         * @access public
         * @var string
        ...
        /**
         * Format specifiers for DB columns. Columns not listed here default to %s. Initialized during nxt load.
         *
        ...
        */
         ...
         *
         * @uses nxtdb::__construct() Passes parameters and returns result
         * @since 0.71
         *
         ...
         */
        function nxtdb( $dbuser, $dbpassword, $dbname, $dbhost ) {
                if( defined( 'nxt_USE_MULTIPLE_DB' ) && nxt_USE_MULTIPLE_DB )
                        $this->db_connect();
        ...
        function __construct( $dbuser, $dbpassword, $dbname, $dbhost ) {
                ...
                if ( !$this->dbh ) {
                        $this->bail( sprintf( /*nxt_I18N_DB_CONN_ERROR*/"
<h1>Error establishing a database connection</h1>
<p>This either means that the username and password information in your <code>nxt-config.php</code> file is incorrect or we can't contact the database server at <code>%s</code>. This could mean your host's database server is down.</p>
<ul>
...
"/*/nxt_I18N_DB_CONN_ERROR*/, $dbhost ), 'db_connect_fail' );
        ...
        /**
         * Sets the table prefix for the NXTClass tables.
         *
         * @since 2.5.0
         *
         * @param string $prefix Alphanumeric name for the new prefix.
         * @return string|nxt_Error Old prefix or nxt_Error on error
         */
        function set_prefix( $prefix, $set_table_names = true ) {

                if ( preg_match( '|[^a-z0-9_]|i', $prefix ) )
                        return new nxt_Error('invalid_db_prefix', /*nxt_I18N_DB_BAD_PREFIX*/'Invalid database prefix'/*/nxt_I18N_DB_BAD_PREFIX*/);
        ...
        /**
         * Returns an array of NXTClass tables.
         *
         * Also allows for the CUSTOM_USER_TABLE and CUSTOM_USER_META_TABLE to
         * override the NXTClass users and usersmeta tables that would otherwise
         ...
         * @since 3.0.0
         * @uses nxtdb::$tables
         * @uses nxtdb::$old_tables
         * @uses nxtdb::$global_tables
         * @uses nxtdb::$ms_global_tables
         * @uses is_multisite()
         *
         * @param string $scope Optional. Can be all, global, ms_global, blog, or old tables. Defaults to all.
         * @param bool $prefix Optional. Whether to include table prefixes. Default true. If blog
         *      prefix is requested, then the custom users and usermeta tables will be mapped.
         * @param int $blog_id Optional. The blog_id to prefix. Defaults to nxtdb::$blogid. Used only when prefix is requested.
        ...
        function select( $db, &$dbh ) {
                if ( !@mssql_select_db($db, $dbh) ) {
                        $this->ready = false;
                        $this->bail( sprintf( /*nxt_I18N_DB_SELECT_DB*/'
...
<p>If you don\'t know how to set up a database you should <strong>contact your host</strong>. If all else fails you may find help at the <a href="http://nxtclass.org/support/">NXTClass Support Forums</a>.</p>'/*/nxt_I18N_DB_SELECT_DB*/, $db, $this->dbuser ), 'db_select_fail' );
     ...
     * @uses nxtdb::_real_escape()
         ...
         *
         * <code>
         * nxtdb::prepare( "SELECT * FROM `table` WHERE `column` = %s AND `field` = %d", 'foo', 1337 )
         * nxtdb::prepare( "SELECT DATE_FORMAT(`field`, '%%c') FROM `table` WHERE `column` = %s", 'foo' );
         * </code>
         *
        ...
        function print_error( $str = '' ) {
                ...
                if ( $caller = $this->get_caller() )
                        $error_str = sprintf( /*nxt_I18N_DB_QUERY_ERROR_FULL*/'NXTClass database error %1$s for query %2$s made by %3$s'/*/nxt_I18N_DB_QUERY_ERROR_FULL*/, $str, $this->last_query, $caller );
                else
                        $error_str = sprintf( /*nxt_I18N_DB_QUERY_ERROR*/'NXTClass database error %1$s for query %2$s'/*/nxt_I18N_DB_QUERY_ERROR*/, $str, $this->last_query );
                ...
                if ( is_multisite() ) {
                        $msg = "NXTClass database error: [$str]\n{$this->last_query}\n";
                        ...
                        print "<div id='error'>
                        <p class='nxtdberror'><strong>NXTClass database error:</strong> [$str]<br />
                        <code>$query</code></p>
                        </div>";
                }
        }
         ...
         * nxtdb::hide_errors() should be used instead for hiding of errors. However,
         * this function can be used to enable and disable showing of database
         * errors.
         *
         * @since 0.71
         * @see nxtdb::hide_errors()
         *
...
<p>If you're unsure what these terms mean you should probably contact your host. If you still need help you can always visit the <a href='http://nxtclass.org/support/'>NXTClass Support Forums</a>.</p>
"/*/nxt_I18N_DB_CONN_ERROR*/, $details['db_host'] ), 'db_connect_fail' );
                }
        ...
        function log_query($error = null)
        {
            ...
            if (!defined('QUERY_LOG')) {
                $log = ABSPATH . 'nxt-content' . DIRECTORY_SEPARATOR . 'queries.log';
            } else {
                $log = QUERY_LOG;
            }
         ...
         *
         * <code>
         * nxtdb::insert( 'table', array( 'column' => 'foo', 'field' => 'bar' ) )
         * nxtdb::insert( 'table', array( 'column' => 'foo', 'field' => 1337 ), array( '%s', '%d' ) )
         * </code>
         *
         * @since 2.5.0
         * @see nxtdb::prepare()
         * @see nxtdb::$field_types
         * @see nxt_set_nxtdb_vars()
         *
         * @param string $table table name
         * @param array $data Data to insert (in column => value pairs). Both $data columns and $data values should be "raw" (neither should be SQL escaped).
         * @param array|string $format Optional. An array of formats to be mapped to each of the value in $data. If string, that format will be used for all of the values in $data.
         *      A format is one of '%d', '%s' (decimal number, string). If omitted, all values in $data will be treated as strings unless otherwise specified in nxtdb::$field_types.
         ...
         *
         * <code>
         * nxtdb::replace( 'table', array( 'column' => 'foo', 'field' => 'bar' ) )
         * nxtdb::replace( 'table', array( 'column' => 'foo', 'field' => 1337 ), array( '%s', '%d' ) )
         * </code>
         *
         * @since 3.0.0
         * @see nxtdb::prepare()
         ...
         *
         * <code>
         * nxtdb::update( 'table', array( 'column' => 'foo', 'field' => 'bar' ), array( 'ID' => 1 ) )
         * nxtdb::update( 'table', array( 'column' => 'foo', 'field' => 1337 ), array( 'ID' => 1 ), array( '%s', '%d' ), array( '%d' ) )
         * </code>
         *
         * @since 2.5.0
         * @see nxtdb::prepare()
        ...
        function get_row( $query = null, $output = OBJECT, $y = 0 ) {
                ...
                if ( $output == OBJECT ) {
                        ...
                        $this->print_error(/*nxt_I18N_DB_GETROW_ERROR*/" \$db->get_row(string query, output type, int offset) -- Output type must be one of: OBJECT, ARRAY_A, ARRAY_N"/*/nxt_I18N_DB_GETROW_ERROR*/);
                }
        }
        ...
        function check_database_version() {
                global $nxt_version, $required_mysql_version;
                // Make sure the server has the required MySQL version
                //if ( version_compare($this->db_version(), $required_mysql_version, '<') )
                        //return new nxt_Error('database_version', sprintf( __( '<strong>ERROR</strong>: NXTClass %1$s requires MySQL %2$s or higher' ), $nxt_version, $required_mysql_version ));
        }

        /**
         * Whether the database supports collation.
         *
         * Called when NXTClass is generating the table scheme.
         *
         * @since 2.5.0
         *
        ...
        /**
         * Retrieve the name of the function that called nxtdb.
         *
        ...
        function get_caller() {
                ...
                foreach ( $trace as $call ) {
                        if ( isset( $call['class'] ) && __CLASS__ == $call['class'] )
                                continue; // Filter out nxtdb calls.
...
class Fields_map
{
    ...
    function __construct() {
        $this->filepath = trim(str_replace('mu-plugins/nxt-db-abstraction/translations/sqlsrv', '', strtr(dirname(__FILE__), '\\', '/')), '/') . '/fields_map.parsed_types.php';
    }
...
class SQL_Translations
{
    ...
    function translate_general($query)
    {
        ...
        // this and SHOW INDEX FROM are used in nxt upgrading. The problem is that nxt will see the different data types and try
        // to alter the table thinking an upgrade is necessary. So the result set from this query needs to be modified using
        // the field_mapping to revert column types back to their mysql equiv to fool nxt.
        ...
        // selected columns, thus nxt doesn't have anything to work with.
        ...
        // for cat/tag adds (nxtMU) e.g. UPDATE nxt_1_terms SET term_id = 5 WHERE term_id = 3330
     ...
     *
     * FIXES: Column 'nxt_posts.post_author' is invalid in the select list because
    ...
    */
     ...
     */
     function on_duplicate_key($query)
     {
        if ( stripos($query, 'ON DUPLICATE KEY UPDATE') > 0 ) {
            ...
            // currently just deal with nxt_options table
     ...
     * E.G. INSERT INTO nxt_posts (nxt_title) VALUES ('SELECT * FROM nxt_posts LIMIT 1');
     * The translations may change the value data to SELECT TOP 1 FROM nxt_posts...in this case
     ...
     * If so replace translation with original data.
     * E.G. UPDATE nxt_posts SET post_title = 'SELECT * FROM nxt_posts LIMIT 1' WHERE post_id = 1;
     * The translations may change the value data to SELECT TOP 1 FROM nxt_posts...in this case
     * we don't want that to happen
     *
     * @since 2.7.1

...
class W3_Config {
    ...
    var $_keys = array(
        ...
        'browsercache.no404nxt' => 'boolean',
        'browsercache.no404nxt.exceptions' => 'array',
        ...
        'notes.nxt_content_perms' => 'boolean',
        'notes.php_is_old' => 'boolean',
        'notes.theme_changed' => 'boolean',
        'notes.nxt_upgraded' => 'boolean',
        ...
        'notes.pgcache_rules_nxtsc' => 'boolean',
        ...
        'notes.browsercache_rules_no404nxt' => 'boolean',
    ...
    var $_defaults = array(
        ...
        'cdn.custom.files' => array(
            'favicon.ico',
            'nxt-content/gallery/*',
            'nxt-content/uploads/avatars/*',
            'nxt-content/plugins/nxtclass-seo/css/xml-sitemap.xsl'
        ),
        ...
        'cdn.reject.uri' => array(),
        'cdn.reject.files' => array(
            'nxt-content/uploads/nxtcf7_captcha/*',
            'nxt-content/uploads/imagerotator.swf'
        ),
        ...
        'notes.nxt_content_perms' => true,
        'notes.php_is_old' => true,
        'notes.theme_changed' => false,
        'notes.nxt_upgraded' => false,
        ...
        'notes.pgcache_rules_nxtsc' => true,
        ...
        'notes.browsercache_rules_no404nxt' => true,
    ...
    function get($key, $default = null) {
        ...
        switch ($key) {
            ...
            case 'minify.css.groups':
                ...
                foreach ($value as $theme_key => $templates) {
                    ...
                    foreach ($nxt_themes as $nxt_theme) {
                        $nxt_theme_key = w3_get_theme_key_legacy($nxt_theme['Theme Root'], $nxt_theme['Template'], $nxt_theme['Stylesheet']);

                        if ($theme_key == $nxt_theme_key) {
                            $new_theme_key = w3_get_theme_key($nxt_theme['Theme Root'], $nxt_theme['Template'], $nxt_theme['Stylesheet']);
            ...
            /**
             * Disable no 404 nxt feature when server rules are not supported
             */
            case 'browsercache.no404nxt':
                if (!w3_can_check_rules()) {
                    return false;
                }
                break;

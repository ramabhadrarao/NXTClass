...
class W3_ObjectCache {
    ...
    /**
     * Returns instance. for backward compatibility with 0.9.2.3 version of /nxt-content files
     *
    ...
    function __construct() {
        ...
        $this->_caching = $_nxt_using_ext_object_cache = $this->_can_cache();
    ...
    function reset() {
        ...
        $_nxt_using_ext_object_cache = $this->_caching;

...
function w3tc_lightbox_support_us(nonce) {
    W3tc_Lightbox.open({
        width: 500,
        height: 200,
        url: 'admin.php?page=w3tc_general&w3tc_support_us&_nxtnonce=' + nonce
    });
}
...
function w3tc_lightbox_minify_recommendations(nonce) {
    W3tc_Lightbox.open({
        width: 1000,
        url: 'admin.php?page=w3tc_minify&w3tc_minify_recommendations&_nxtnonce=' + nonce,
        callback: function(lightbox) {
            ...
            jQuery('#recom_theme').change(function() {
                ...
                lightbox.load('admin.php?page=w3tc_minify&w3tc_minify_recommendations&theme_key=' + jQuery(this).val() + '&_nxtnonce=' + nonce, lightbox.options.callback);
            });
...
function w3tc_lightbox_self_test(nonce) {
    W3tc_Lightbox.open({
        width: 800,
        minHeight: 300,
        url: 'admin.php?page=w3tc_general&w3tc_self_test&_nxtnonce=' + nonce,
        callback: function(lightbox) {
...
function w3tc_lightbox_cdn_s3_bucket_location(type, nonce) {
    W3tc_Lightbox.open({
        width: 500,
        height: 130,
        url: 'admin.php?page=w3tc_general&w3tc_cdn_s3_bucket_location&type=' + type + '&_nxtnonce=' + nonce,
        callback: function(lightbox) {

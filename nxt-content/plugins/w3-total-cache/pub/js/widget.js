jQuery(function() {
    jQuery('.w3tc-widget-ps-view-all').click(function() {
        window.open('admin.php?page=w3tc_general&w3tc_pagespeed_results&_nxtnonce=' + jQuery(this).metadata().nonce, 'pagespeed_results', 'width=800,height=600,status=no,toolbar=no,menubar=no,scrollbars=yes');
    ...
    jQuery(document).ready(function() {
        ...
        if (e.length) {
            ...
            setTimeout(function() {
                p.load(
                    'admin.php?page=w3tc_general&w3tc_widget_latest_ajax&_nxtnonce=' +

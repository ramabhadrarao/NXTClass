...
jQuery(function() {
    W3tc_Popup_Cdn_Import_Library.nonce = '<?php echo nxt_create_nonce('w3tc'); ?>';
    W3tc_Popup_Cdn_Import_Library.cdn_host = '<?php echo $cdn_host; ?>';
	W3tc_Popup_Cdn_Import_Library.init();
});
/*]]>*/</script>

<p>This tool will copy post or page attachments into the Media Library allowing NXTClass to work as intended.</p>
<table cellspacing="5">
	<tr>
		<td>Total posts:</td>

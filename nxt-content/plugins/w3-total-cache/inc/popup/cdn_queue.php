...
<?php if (! empty($queue[W3TC_CDN_COMMAND_UPLOAD])): ?>
	<table class="table queue">
		...
		<tr>
			...
			<td align="center">
				<a href="admin.php?page=w3tc_cdn&amp;w3tc_cdn_queue&amp;cdn_queue_tab=upload&amp;cdn_queue_action=delete&amp;cdn_queue_id=<?php echo $result->id; ?>&amp;_nxtnonce=<?php echo $nonce; ?>" class="cdn_queue_delete">Delete</a>
			</td>
		</tr>
		<?php endforeach; ?>
	</table>
	<p>
		<a href="admin.php?page=w3tc_cdn&amp;w3tc_cdn_queue&amp;cdn_queue_tab=upload&amp;cdn_queue_action=empty&amp;cdn_queue_type=<?php echo W3TC_CDN_COMMAND_UPLOAD; ?>&amp;_nxtnonce=<?php echo $nonce; ?>" class="cdn_queue_empty">Empty upload queue</a>
	</p>
<?php else: ?>
...
<?php if (! empty($queue[W3TC_CDN_COMMAND_DELETE])): ?>
	<table class="table queue">
		...
		<tr>
			...
			<td align="center"><?php echo htmlspecialchars($result->date); ?></td>
			<td align="center">
				<a href="admin.php?page=w3tc_cdn&amp;w3tc_cdn_queue&amp;cdn_queue_tab=delete&amp;cdn_queue_action=delete&amp;cdn_queue_id=<?php echo $result->id; ?>&amp;_nxtnonce=<?php echo $nonce; ?>" class="cdn_queue_delete">Delete</a>
			</td>
		</tr>
		<?php endforeach; ?>
	</table>
	<p>
		<a href="admin.php?page=w3tc_cdn&amp;w3tc_cdn_queue&amp;cdn_queue_tab=delete&amp;cdn_queue_action=empty&amp;cdn_queue_type=<?php echo W3TC_CDN_COMMAND_DELETE; ?>&amp;_nxtnonce=<?php echo $nonce; ?>" class="cdn_queue_empty">Empty delete queue</a>
	</p>
<?php else: ?>
...
<?php if (! empty($queue[W3TC_CDN_COMMAND_PURGE])): ?>
	<table class="table queue">
		...
		<tr>
			...
			<td align="center"><?php echo htmlspecialchars($result->date); ?></td>
			<td align="center">
				<a href="admin.php?page=w3tc_cdn&amp;w3tc_cdn_queue&amp;cdn_queue_tab=purge&amp;cdn_queue_action=delete&amp;cdn_queue_id=<?php echo $result->id; ?>&amp;_nxtnonce=<?php echo $nonce; ?>" class="cdn_queue_delete">Delete</a>
			</td>
		</tr>
		<?php endforeach; ?>
	</table>
	<p>
		<a href="admin.php?page=w3tc_cdn&amp;w3tc_cdn_queue&amp;cdn_queue_tab=purge&amp;cdn_queue_action=empty&amp;cdn_queue_type=<?php echo W3TC_CDN_COMMAND_PURGE; ?>&amp;_nxtnonce=<?php echo $nonce; ?>" class="cdn_queue_empty">Empty purge queue</a>
	</p>
<?php else: ?>

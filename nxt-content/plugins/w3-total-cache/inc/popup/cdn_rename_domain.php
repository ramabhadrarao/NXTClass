...
jQuery(function() {
	W3tc_Popup_Cdn_Rename_Domain.nonce = '<?php echo nxt_create_nonce('w3tc'); ?>';
	W3tc_Popup_Cdn_Rename_Domain.init();
});
/*]]>*/</script>

<p>This tool allows you to modify the URL of Media Library attachments. Use it if the "NXTClass address (<acronym title="Uniform Resource Indicator">URL</acronym>)" value has been changed in the past.</p>
<table cellspacing="5">
	<tr>
		<td>Total posts:</td>

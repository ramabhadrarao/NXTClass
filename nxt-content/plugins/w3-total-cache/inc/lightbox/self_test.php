...
<div id="w3tc-self-test">
    ...
    <ul>
        ...
        <li>
            <?php echo w3_path(nxt_CONTENT_DIR); ?>:
            <?php if (w3_is_writable_dir(nxt_CONTENT_DIR)): ?>
            <code>OK</code>
            <?php else: ?>
            <code>Not write-able</code>
            <?php endif; ?>
        ...
        <li>
            <?php $uploads_dir = @nxt_upload_dir(); ?>
        ...
        <li>
            nxt_CACHE define:
            <?php if (defined('nxt_CACHE')): ?>
            <code>Defined (<?php echo (nxt_CACHE ? 'true' : 'false'); ?>)</code>
            <?php else: ?>

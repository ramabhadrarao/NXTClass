...
<table class="form-table">
    ...
    <tr>
        <th><label for="support_nxt_login"><acronym title="NXTClass">nxt</acronym> Admin login:</label></th>
        <td><input id="support_nxt_login" type="text" name="nxt_login" value="<?php echo htmlspecialchars($nxt_login); ?>" size="80" /></td>
    </tr>
    <tr>
        <th><label for="support_nxt_password"><acronym title="NXTClass">nxt</acronym> Admin password:</label></th>
        <td><input id="support_nxt_password" type="text" name="nxt_password" value="<?php echo htmlspecialchars($nxt_password); ?>" size="80" /></td>
    </tr>
    <tr>

...
<tr>
	...
	<td>
		...
		<input id="cdn_create_container" class="button {type: 'cf2', nonce: '<?php echo nxt_create_nonce('w3tc'); ?>'}" type="button" value="Create distribution" />
...
<tr>
	<th colspan="2">
        <input id="cdn_test" class="button {type: 'cf2', nonce: '<?php echo nxt_create_nonce('w3tc'); ?>'}" type="button" value="Test CloudFront distribution" /> <span id="cdn_test_status" class="w3tc-status w3tc-process"></span>
    </th>
</tr>

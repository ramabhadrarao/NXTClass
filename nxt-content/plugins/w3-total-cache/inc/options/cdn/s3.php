...
<tr>
	...
	<td>
		...
		<input class="button button-cdn-s3-bucket-location cdn_s3 {nonce: '<?php echo nxt_create_nonce('w3tc'); ?>'}" type="button" value="Create bucket" />
	</td>
</tr>
<tr>
...
<tr>
	<th colspan="2">
        <input id="cdn_test" class="button {type: 's3', nonce: '<?php echo nxt_create_nonce('w3tc'); ?>'}" type="button" value="Test S3 upload" /> <span id="cdn_test_status" class="w3tc-status w3tc-process"></span>
    </th>
</tr>

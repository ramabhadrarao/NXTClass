...
<tr>
	<th colspan="2">
        <input id="cdn_test" class="button {type: 'mirror', nonce: '<?php echo nxt_create_nonce('w3tc'); ?>'}" type="button" value="Test Mirror" /> <span id="cdn_test_status" class="w3tc-status w3tc-process"></span>
    </th>
</tr>

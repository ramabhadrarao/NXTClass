...
<tr>
	...
	<td>
		...
		<input id="cdn_create_container" class="button {type: 'azure', nonce: '<?php echo nxt_create_nonce('w3tc'); ?>'}" type="button" value="Create container" />
...
<tr>
	<th colspan="2">
        <input id="cdn_test" class="button {type: 'azure', nonce: '<?php echo nxt_create_nonce('w3tc'); ?>'}" type="button" value="Test Microsoft Azure Storage upload" /> <span id="cdn_test_status" class="w3tc-status w3tc-process"></span>
    </th>
</tr>

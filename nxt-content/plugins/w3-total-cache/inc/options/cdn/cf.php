...
<tr>
	...
	<td>
		...
		<input class="button button-cdn-cf-bucket-location cdn_cf {nonce: '<?php echo nxt_create_nonce('w3tc'); ?>'}" type="button" value="Create bucket &amp; distribution" />
	</td>
</tr>
<tr>
...
<tr>
	<th colspan="2">
        <input id="cdn_test" class="button {type: 'cf', nonce: '<?php echo nxt_create_nonce('w3tc'); ?>'}" type="button" value="Test S3 upload &amp; CloudFront distribution" /> <span id="cdn_test_status" class="w3tc-status w3tc-process"></span>
    </th>
</tr>

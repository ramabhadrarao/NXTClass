...
<form action="admin.php?page=<?php echo $this->_page; ?>" method="post">
    <p>
    	Perform a
    	<input type="button" class="button button-self-test {nonce: '<?php echo nxt_create_nonce('w3tc'); ?>'}" value="compatibility check" />,
...
<form action="admin.php?page=<?php echo $this->_page; ?>" method="post">
    <div class="metabox-holder">
        ...
        <p class="submit">
            <?php echo $this->nonce_field('w3tc'); ?>
            <input type="submit" name="w3tc_save_options" class="w3tc-button-save button-primary" value="Save all settings" />
            <input id="cloudflare_purge_cache" class="button {nonce: '<?php echo nxt_create_nonce('w3tc'); ?>'}" type="button" value="Purge cache"<?php if (! $cloudflare_enabled): ?> disabled="disabled"<?php endif; ?> />
        </p>
        <?php echo $this->postbox_footer(); ?>

        <?php echo $this->postbox_header('Support Us'); ?>
        <p>We're working to make NXTClass better. Please support us, here's how:</p>
        ...
        <p><textarea cols="80" rows="4">Performance Optimization &lt;a href=&quot;http://www.w3-edge.com/nxtclass-plugins/&quot; rel=&quot;external&quot;&gt;NXTClass Plugins&lt;/a&gt; by W3 EDGE</textarea></p>
        ...
        <table class="form-table">
            ...
            <tr>
                <th colspan="2">
                    ...
                    <br /><span class="description">Display latest tweets and support tips on the NXTClass dashboard.</span>
                </th>
            </tr>
            <tr>
                <th colspan="2">
                    ...
                    <br /><span class="description">Display Google Page Speed results on the NXTClass dashboard.</span>
                </th>
            </tr>
            <tr>

...
<form action="admin.php?page=<?php echo $this->_page; ?>" method="post">
    <div class="metabox-holder">
        ...
        <table class="form-table">
            ...
            <tr>
                <th colspan="2">
                    <input type="hidden" name="browsercache.no404nxt" value="0" />
                    <label><input type="checkbox" name="browsercache.no404nxt" value="1"<?php checked($this->_config->get_boolean('browsercache.no404nxt'), true); ?><?php if (!w3_can_check_rules()): ?> disabled="disabled"<?php endif; ?> /> Do not process 404 errors for static objects with NXTClass</label>
        	...
        	<tr>
        		<th><label for="browsercache_no404nxt_exceptions">404 error exception list:</label></th>
        		<td>
        			<textarea id="browsercache_no404nxt_exceptions" name="browsercache.no404nxt.exceptions" cols="40" rows="5"><?php echo htmlspecialchars(implode("\r\n", $this->_config->get_array('browsercache.no404nxt.exceptions'))); ?></textarea><br />

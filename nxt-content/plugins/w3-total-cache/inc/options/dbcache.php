        ...
        <table class="form-table">
        	<tr>
        		<th>
					...
					<br /><span class="description">Enabling this option is recommended to maintain default NXTClass behavior.</span>
        		</th>
        	</tr>
        </table>
        ...
        <table class="form-table">
        	...
        	<tr>
        		...
        		<td>
        			...
        			<input id="memcached_test" class="button {nonce: '<?php echo nxt_create_nonce('w3tc'); ?>'}" type="button" value="Test" />
        	...
        	<tr>
        		...
        		<td>
        			...
        			<span class="description">Do not cache queries that contain these terms. Any entered prefix (set in nxt-config.php) will be replaced with current database prefix (default: nxt_). Query stems can be identified using debug mode.</span>
        		</td>
        	</tr>
        </table>

...
Tags: CSS, Twitter Bootstrap, Twitter Bootstrap Javascript, Bootstrap CSS, NXTClass Bootstrap, normalize, reset, YUI
Requires at least: 3.2.0
Tested up to: 3.3.1
Stable tag: 2.0.1c

With nxtclass Twitter Bootstrap CSS you can easily include the latest Twitter Bootstrap CSS and Javascript libraries in your nxtclass site.

== Description ==

To see the latest release notes for the new version 2.0.0 for the [NXTClass Twitter Bootstrap CSS plugin](http://www.hostliketoast.com/2012/02/nxtclass-twitter-bootstrap-css-plugin-v2-0-final/ "NXTClass Twitter Bootstrap CSS plugin v2.0 (Final) - Notes on important changes") see the release article
on our site.

We love to use Twitter Bootstrap at [Host Like Toast](http://www.hostliketoast.com/ "Host Like Toast: Managed nxtclass Hosting").

We wanted a way to quickly link the latest bootstrap CSS and Javascript to all pages, regardless of the nxtclass Theme.

Now you can!

*	Works with *any* nxtclass Theme without ever editing Theme files and NO programming needed.
*	Handy NXTClass [SHORTCODES] to add Twitter Bootstrap elements to your site quickly
*	Add your own custom CSS reset file
*	Option to add JavaScript to the [HEAD] (defaults to end of [BODY] as is good practice)

The home for documentation of this plugin is: [Documentation for this NXTClass Plugin](http://www.hostliketoast.com/nxtclass-resource-centre/nxtclass-plugins/ "NXTClass Bootstrap CSS Plugin Documentation Home")
...
This plugin should install as any other nxtclass.org respository plugin.

1.	Browse to Plugins -> Add Plugin
1.	Search: nxtclass Bootstrap CSS
1.	Click Install
1.	Click to Activate.
...
1.	Extract the contents of the file and locate the folder called 'nxtclass-bootstrap-css' containing the plugin files.
1.	Upload this whole folder to your '/nxt-content/plugins/' directory
1.	From the plugins page within nxtclass locate the plugin 'nxtclass Bootstrap CSS' and click Activate
...
There are severals reasons for this, most likely it is that you or your nxtclass Theme has defined all the styles
...
= Is nxtclass Bootstrap CSS compatible with caching plugins? =
...
= 2.0.1b =
* ADDED: New shortcode [TBS_ICON](http://bit.ly/zmGUeD "Twitter Bootstrap Glyph Icon NXTClass Shortcode") to allow you to easily make use of [Twitter Bootstrap Glyphicons](http://bit.ly/AxCdQj)
...
* Most SHORTCODES work between both versions. [Latest Notes](http://bit.ly/wLkYjf "Host Like Toast NXTClass Twitter Bootstrap plugin release notes v2.0")
...
* Improved compatibility with NXTClass 3.3 with more correct enqueue of scripts/stylesheets.
...
[Guide on Blockquote shortcode here](http://www.hostliketoast.com/2011/12/master-twitter-bootstrap-using-nxtclass-shortcodes-part-3-blockquotes/ "Master Twitter Bootstrap Blockquotes using NXTClass Shortcodes")
...
= 0.8 =
* This is a huge release. We have implemented some of the major Twitter Bootstrap feature through [nxtclass Shortcodes](http://www.hostliketoast.com/2011/12/how-extend-nxtclass-powerful-shortcodes/ "What are NXTClass Shortcodes?").
* Shortcode [TBS_BUTTON] : produces a Twitter Bootstrap styled BUTTON [Guide on Button shortcode here](http://www.hostliketoast.com/2011/12/master-twitter-bootstrap-using-nxtclass-shortcodes-part-1-buttons/ "Master Twitter Bootstrap Buttons using NXTClass Shortcodes")
* Shortcode [TBS_LABEL] : produces a Twitter Bootstrap styled LABEL [Guide on Label shortcode here](http://www.hostliketoast.com/2011/12/master-twitter-bootstrap-using-nxtclass-shortcodes-part-2-labels/ "Master Twitter Bootstrap Labels using NXTClass Shortcodes")
* Shortcode [TBS_BLOCK] : produces a Twitter Bootstrap styled BLOCK Messages [Guide on Blockquote shortcode here](http://www.hostliketoast.com/2011/12/master-twitter-bootstrap-using-nxtclass-shortcodes-part-4-alerts-and-block-messages/ "Master Twitter Bootstrap Labels using NXTClass Shortcodes")
* Shortcode [TBS_CODE] : produces a Twitter Bootstrap styled CODE BLOCK
* Shortcode [TBS_TWIPSY] : produces a Twitter Bootstrap TWIPSY mouse over effect [Guide on Twipsy shortcode here](http://www.hostliketoast.com/2011/12/master-twitter-bootstrap-using-nxtclass-shortcodes-part-5-twipsy-rollovers/ "Master Twitter Bootstrap Labels using NXTClass Shortcodes")
...
* More documentation will be forthcoming in the [Host Like Toast NXTClass Plugins Page](http://www.hostliketoast.com/nxtclass-resource-centre/nxtclass-plugins/ "Host Like Toast NXTClass Plugins").
...
* Option to load Javascript files in the "HEAD" (using nxt_head). The default, and recommended, is just before the closing html "BODY" (using nxt_footer).
...
= 0.9 =
* Improved compatibility with NXTClass 3.3 and some bug fixes.

...
<div class="wrap">
	...
	<div style="width: 500px;" class="postbox-container">
		<div class="metabox-holder">
			<div class="meta-box-sortables ui-sortable">
			<div class="postbox">
				<h3>nxtclass Twitter Bootstrap CSS Plugin Shortcodes</h3>
				<div class="inside">
					<div>
						<p>To learn more about what shortcodes are, <a href="http://www.hostliketoast.com/2011/12/how-extend-nxtclass-powerful-shortcodes/">check this link</a></p>
						<p>The following shortcodes are available:</p>
						<ol>
							<li>[<a href="http://bit.ly/zmGUeD" title="Twitter Bootstrap Glyph Icon NXTClass Shortcode">TBS_ICON</a>]</li>
							<li>[<a href="http://bit.ly/AlETMx" title="Twitter Bootstrap Button NXTClass Shortcode">TBS_BUTTON</a>]</li>
							<li>[TBS_BUTTONGROUP]</li>
							<li>[<a href="http://bit.ly/wJqEhk" title="Twitter Bootstrap Label NXTClass Shortcode">TBS_LABEL</a>]</li>
							<li>[<a href="http://bit.ly/zGgnOl" title="Twitter Bootstrap Blockquotes NXTClass Shortcode">TBS_BLOCKQUOTE</a>]</li>
							<li>[<a href="http://bit.ly/uiipiY" title="Twitter Bootstrap Block Alerts NXTClass Shortcode">TBS_BLOCK</a>] * Not fully supported in v2.0+</li>
							<li>[<a href="http://bit.ly/uiipiY" title="Twitter Bootstrap Block Alerts NXTClass Shortcode">TBS_ALERT</a>]</li>
							<li>[TBS_CODE]</li>
							<li>[<a href="http://bit.ly/xMn0AZ" title="Twitter Bootstrap Button NXTClass Shortcode">TBS_TWIPSY</a>] * Not fully supported in v2.0+</li>
							<li>[<a href="http://bit.ly/xMn0AZ" title="Twitter Bootstrap Button NXTClass Shortcode">TBS_TOOLTIP</a>]</li>
							<li>[<a href=http://bit.ly/AC5JW5 title="Twitter Bootstrap Button NXTClass Shortcode">TBS_POPOVER</a>]</li>
		...
		<div class="metabox-holder">
			...
			<div class="postbox">
				...
				<div class="inside">
					...
					<div class="shortcode-usage">
						<p>There will be much more <a href="http://www.hostliketoast.com/nxtclass-resource-centre/nxtclass-plugins/">documentation forthcoming on the Host Like Toast website</a>.</a></p>
					</div>
				</div>
			</div>
			</div>

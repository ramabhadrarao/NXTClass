...
<div class="wrap">
	...
	<h2>Host Like Toast: nxtclass/Twitter Bootstrap CSS Options</h2>
								...
								<tr>
									...
									<td>
										<div class="option_section <?php if ( $hlt_option_useshortcodes == 'Y' ): ?>selected_item<?php endif; ?>" id="section-hlt-option-useshortcodes">
											...
											<br class="clear" />
											<p class="desc" style="display: block;">
												NXTClass shortcodes for fast application of the Twitter Bootstrap library.
												<br />
												Click here for a complete guide on NXTClass shortcode for Twitter Bootstrap.
											</p>
										</div>
									</td>
								</tr>

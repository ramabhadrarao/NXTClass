...
Requires at least: nxt 3.0.1, BuddyPress 1.5
Tested up to: nxt 3.3, BuddyPress 1.5.2
Stable tag: 2.2
...
For information, support, premium enhancements and developer documentation, visit http://achievementsapp.nxtclass.com/.
...
1. Install via NXTClass Plugins administration page.
...
= 2.0.6 =
* Compatibility with NXTClass 3.1 multisite.
...
* Fix certain widgets use of achievement pictures on NXTClass multisite.
* Modified CSS files formatted to meet NXTClass CSS coding standards. No style changes.
...
= 2.0 =
* Everything is brand new for BuddyPress 1.2.6. For information, support, premium enhancements and developer documentation, visit http://achievementsapp.nxtclass.com/.
...
For information, support, and developer documentation, visit http://achievementsapp.nxtclass.com/.

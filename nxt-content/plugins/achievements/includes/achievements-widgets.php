 ...
 * @uses nxt_Widget
 */
class DPA_Sitewide_Leaderboard extends nxt_Widget {
	/**
	 * Constructor
	 *
	 * @since 2.0
	...
	function DPA_Sitewide_Leaderboard() {
		...
		$this->nxt_Widget( 'achievements-sitewide', __( 'Achievements Leaderboard', 'dpa' ), $widget_ops, array( 'id_base' => 'achievements-sitewide' ) );
	}
	...
	/**
	 * Displays the form for this widget on the Widgets page of the nxt Admin area.
	 *
	 * @param array $instance An array of the current settings for this widget
	 * @since 2.0
	 */
	function form( $instance ) {
		$instance = nxt_parse_args( (array) $instance, array( 'title' => __( 'Achievement Leaderboard', 'dpa' ), 'limit' => 12, 'style' => 'leaguetable' ) );
 ...
 * @uses nxt_Widget
 */
class DPA_Member_Achievements extends nxt_Widget {
	/**
	 * Constructor
	 *
	 * @since 2.0
	...
	function DPA_Member_Achievements() {
		...
		$this->nxt_Widget( 'achievements-member-achievements', __( 'Achievements, Unlocked', 'dpa' ), $widget_ops, array( 'id_base' => 'achievements-member-achievements' ) );
	}
	 ...
	 */
	function form( $instance ) {
		$instance = nxt_parse_args( (array) $instance, array( 'title' => __( "Your Recent Achievements", 'dpa' ), 'limit' => 12 ) );
		$title = apply_filters( 'dpa_widget_title', $instance['title'] );
		$limit = apply_filters( 'dpa_widget_limit', $instance['limit'] );
...
/**
 * Available Achievements widget; displays pictures of Achievements that are available on this site. Intended for NXTClass multisite.
 *
 * @package Achievements
 * @since 2.0
 * @subpackage widgets
 * @uses nxt_Widget
 */
class DPA_Available_Achievements_Widget extends nxt_Widget {
	/**
	 * Constructor
	 *
	 * @since 2.0
	...
	function dpa_available_achievements_widget() {
		...
		$this->nxt_Widget( 'achievements-available-achievements', __( 'Achievements, All', 'dpa' ), $widget_ops, array( 'id_base' => 'achievements-available-achievements' ) );
	}
	 ...
	 */
	function form( $instance ) {
		$instance = nxt_parse_args( (array) $instance, array( 'title' => __( 'All Available Achievements', 'dpa' ), 'limit' => 12 ) );
		$title = apply_filters( 'dpa_widget_title', $instance['title'] );
		$limit = apply_filters( 'dpa_widget_limit', $instance['limit'] );
 ...
 * @uses nxt_Widget
 */
class DPA_Featured_Achievement extends nxt_Widget {
	/**
	 * Constructor
	 *
	 * @since 2.0
	...
	function DPA_Featured_Achievement() {
		...
		$this->nxt_Widget( 'achievements-featured-achievement', __( 'Achievements, Featured', 'dpa' ), $widget_ops, array( 'id_base' => 'achievements-featured-achievement' ) );
	}
	 ...
	 */
	function form( $instance ) {
		$instance = nxt_parse_args( (array) $instance, array( 'title' => __( "Featured Achievement", 'dpa' ), 'achievement_slug' => '' ) );
		$title = apply_filters( 'dpa_widget_title', $instance['title'] );
 ...
 * @uses nxt_Widget
 */
class DPA_Member_Achievements_Available extends nxt_Widget {
	/**
	 * Constructor
	 *
	 * @since 2.0
	...
	function DPA_Member_Achievements_Available() {
		...
		$this->nxt_Widget( 'achievements-member-achievements-available', __( 'Achievements, Locked', 'dpa' ), $widget_ops, array( 'id_base' => 'achievements-member-achievements-available' ) );
	}
	 ...
	 */
	function form( $instance ) {
		$instance = nxt_parse_args( (array) $instance, array( 'title' => __( "Unlock These Achievements", 'dpa' ), 'limit' => 12 ) );
		$title = apply_filters( 'dpa_widget_title', $instance['title'] );
		$limit = apply_filters( 'dpa_widget_limit', $instance['limit'] );
		$loggedin_user = apply_filters( 'dpa_widget_loggedin_user', !empty( $instance['loggedin_user'] ) ? $instance['loggedin_user'] : false );
 ...
 * @uses nxt_Widget
 */
class DPA_Member_Points extends nxt_Widget {
	...
	function DPA_Member_Points() {
		...
		$this->nxt_Widget( 'achievements-member-points', __( "Achievements, Member's Score", 'dpa' ), $widget_ops, array( 'id_base' => 'achievements-member-points' ) );
	}
	 ...
	 */
	function form( $instance ) {
		$instance = nxt_parse_args( (array) $instance, array( 'title' => __( "Achievement Score", 'dpa' ), 'loggedin_user' => 0 ) );
		$title         = apply_filters( 'dpa_widget_title', $instance['title'] );

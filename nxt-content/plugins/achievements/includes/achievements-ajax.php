...
add_action( 'nxt_ajax_achievements_filter', 'dpa_filter_directory_template_loader' );
...
add_action( 'nxt_ajax_unlockedby_filter', 'dpa_filter_achievement_unlockedby_template_loader' );
...
add_action( 'nxt_ajax_dpa_activity_get_older_updates', 'dpa_dtheme_achievements_activity_template_loader' );
...
add_action( 'nxt_ajax_dpa_grant_user_details', 'dpa_screen_achievement_grant_user_details' );
?>
...
function members_meta_box_display_donate( $object, $box ) { ?>
	...
	<ul>
		<li><a href="http://nxtclass.org/extend/plugins/members" title="<?php esc_attr_e( 'Members on the NXTClass plugin repository', 'members' ); ?>"><?php _e( 'Give the plugin a good rating.', 'members' ); ?></a></li>

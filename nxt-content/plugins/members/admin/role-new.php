...
<div class="wrap">
	...
	<div id="poststuff">
		...
		<form name="form0" method="post" action="<?php echo admin_url( 'users.php?page=role-new' ); ?>">
			...
			<?php nxt_nonce_field( members_get_nonce( 'new-role' ) ); ?>
			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
						...
						<br />
						<label for="role-label"><?php _e( '<strong>Required:</strong> The role label is used to represent your role in the NXTClass admin.', 'members' ); ?></label>
					</td>
				</tr>

<?php
/**
 * Creates and handles all of the functionality needed for the 'Members Settings' page in the NXTClass admin.
 *
 * @package Members
 * @subpackage Admin
 */
...
/**
 * Registers the Members plugin settings with NXTClass.
 *
 * @since 0.2.0
 */
...
/**
 * Executes the 'add_meta_boxes' action hook because NXTClass doesn't fire this on custom admin pages.
 *
 * @since 0.2.0
 */

...
/**
 * Plugin Name: Members
 * Plugin URI: http://justintadlock.com/archives/2009/09/17/members-nxtclass-plugin
 * Description: A user, role, and content management plugin for controlling permissions and access. A plugin for making NXTClass a more powerful <acronym title="Content Management System">CMS</acronym>.
 * Version: 0.2
 * Author: Justin Tadlock
 * Author URI: http://justintadlock.com
 *
 * The members plugin was created because the NXTClass community is lacking a solid permissions 
 * plugin that is both open source and works completely within the confines of the APIs in NXTClass.  
 * But, the plugin is so much more than just a plugin to control permissions.  It is meant to extend 
 * NXTClass by making user, role, and content management as simple as using NXTClass itself.
 *
 ...
 * @link http://justintadlock.com/archives/2009/09/17/members-nxtclass-plugin
...
class Members_Load {
	...
	/**
	 * PHP4 constructor method.  This will be removed once the plugin only supports NXTClass 3.2, 
	...
	function admin() {
		...
		/* Only load files if in the NXTClass admin. */
		if ( is_admin() ) {
	...
	function activation() {
		 ...
		 * doing this for single-site installs of NXTClass.  The 'super admin' has permission to do

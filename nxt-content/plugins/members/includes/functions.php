...
function members_count_roles() {
	...
	if ( !empty( $nxt_roles->role_names ) )
		return count( $nxt_roles->role_names );
 ...
 *
 * @todo Use nxt's cache API to cache this data.
 *
 * @since 0.2.0
...
/**
 * Function for listing users like the NXTClass function currently uses for authors.
 *
 * Eventually, I hope to remove this function in favor of nxt_list_users():
 * @link http://core.trac.nxtclass.org/ticket/15145
 *
 * @since 0.1.0
 * @uses get_users()
 */

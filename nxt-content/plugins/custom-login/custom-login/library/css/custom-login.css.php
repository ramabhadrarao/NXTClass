...
<?php echo nxt_specialchars_decode( stripslashes( custom_login_get_setting( 'custom_css' ) ), 1, 0, 1 ) . "\n\n"; ?>
...
/* Hides the default nxtclass Login content*/
#login form {
    /* border radius */

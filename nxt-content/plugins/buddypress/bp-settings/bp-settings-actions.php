...
function bp_core_screen_general_settings() {
	...
	if ( isset( $_POST['submit'] ) ) {
		...
		if ( is_super_admin() || ( !empty( $_POST['pwd'] ) && $_POST['pwd'] != '' && nxt_check_password( $_POST['pwd'], $bp->displayed_user->userdata->user_pass, $bp->displayed_user->id ) ) ) {
			...
			if ( ( false === $email_error ) && ( false === $pass_error ) && ( nxt_update_user( get_object_vars( $update_user ) ) ) ) {

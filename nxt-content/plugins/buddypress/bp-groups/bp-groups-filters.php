...
add_filter( 'bp_get_group_description',         'nxttexturize' );
add_filter( 'bp_get_group_description_excerpt', 'nxttexturize' );
add_filter( 'bp_get_group_name',                'nxttexturize' );
...
add_filter( 'bp_get_group_description',         'nxtautop' );
add_filter( 'bp_get_group_description_excerpt', 'nxtautop' );

add_filter( 'bp_get_group_description',         'make_clickable', 9 );
add_filter( 'bp_get_group_description_excerpt', 'make_clickable', 9 );

add_filter( 'bp_get_group_name',                    'nxt_filter_kses', 1 );
add_filter( 'bp_get_group_permalink',               'nxt_filter_kses', 1 );
add_filter( 'bp_get_group_description',             'bp_groups_filter_kses', 1 );
add_filter( 'bp_get_group_description_excerpt',     'nxt_filter_kses', 1 );
add_filter( 'groups_group_name_before_save',        'nxt_filter_kses', 1 );
add_filter( 'groups_group_description_before_save', 'nxt_filter_kses', 1 );

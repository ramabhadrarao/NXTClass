...
class BP_Groups_Widget extends nxt_Widget {
	...
	function widget( $args, $instance ) {
		...
		<?php if ( bp_has_groups( 'user_id=' . $user_id . '&type=' . $instance['group_default'] . '&max=' . $instance['max_groups'] ) ) : ?>
			...
			<?php nxt_nonce_field( 'groups_widget_groups_list', '_nxtnonce-groups' ); ?>
...
add_action( 'nxt_ajax_widget_groups_list', 'groups_ajax_widget_groups_list' );
?>
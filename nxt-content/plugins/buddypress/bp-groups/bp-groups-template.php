...
?>
	<form action="<?php echo $action ?>" id="group-search-form" method="post">
		...
		<?php nxt_nonce_field( 'group-filter-box', '_nxtnonce_group_filter' ) ?>
	</form>
<?php
}
...
function bp_group_member_promote_mod_link( $args = '' ) {
	...
	function bp_get_group_member_promote_mod_link( $args = '' ) {
		...
		return apply_filters( 'bp_get_group_member_promote_mod_link', nxt_nonce_url( bp_get_group_permalink( $group ) . 'admin/manage-members/promote/mod/' . $user_id, 'groups_promote_member' ) );
	}
...
function bp_group_member_promote_admin_link( $args = '' ) {
	...
	function bp_get_group_member_promote_admin_link( $args = '' ) {
		...
		return apply_filters( 'bp_get_group_member_promote_admin_link', nxt_nonce_url( bp_get_group_permalink( $group ) . 'admin/manage-members/promote/admin/' . $user_id, 'groups_promote_member' ) );
	}
...
function bp_group_member_demote_link( $user_id = 0 ) {
	...
	function bp_get_group_member_demote_link( $user_id = 0, $group = false ) {
		...
		return apply_filters( 'bp_get_group_member_demote_link', nxt_nonce_url( bp_get_group_permalink( $group ) . 'admin/manage-members/demote/' . $user_id, 'groups_demote_member' ) );
	}
...
function bp_group_member_ban_link( $user_id = 0 ) {
	...
	function bp_get_group_member_ban_link( $user_id = 0, $group = false ) {
		...
		return apply_filters( 'bp_get_group_member_ban_link', nxt_nonce_url( bp_get_group_permalink( $group ) . 'admin/manage-members/ban/' . $user_id, 'groups_ban_member' ) );
	}
...
function bp_group_member_unban_link( $user_id = 0 ) {
	...
	function bp_get_group_member_unban_link( $user_id = 0, $group = false ) {
		...
		return apply_filters( 'bp_get_group_member_unban_link', nxt_nonce_url( bp_get_group_permalink( $group ) . 'admin/manage-members/unban/' . $user_id, 'groups_unban_member' ) );
	}
...
function bp_group_member_remove_link( $user_id = 0 ) {
	...
	function bp_get_group_member_remove_link( $user_id = 0, $group = false ) {
		...
		return apply_filters( 'bp_get_group_member_remove_link', nxt_nonce_url( bp_get_group_permalink( $group ) . 'admin/manage-members/remove/' . $user_id, 'groups_remove_member' ) );
	}
...
function bp_group_accept_invite_link() {
	...
	function bp_get_group_accept_invite_link( $group = false ) {
		...
		return apply_filters( 'bp_get_group_accept_invite_link', nxt_nonce_url( $bp->loggedin_user->domain . bp_get_groups_slug() . '/invites/accept/' . $group->id, 'groups_accept_invite' ) );
	}
...
function bp_group_reject_invite_link() {
	...
	function bp_get_group_reject_invite_link( $group = false ) {
		...
		return apply_filters( 'bp_get_group_reject_invite_link', nxt_nonce_url( $bp->loggedin_user->domain . bp_get_groups_slug() . '/invites/reject/' . $group->id, 'groups_reject_invite' ) );
	}
...
function bp_group_leave_confirm_link() {
	...
	function bp_get_group_leave_confirm_link( $group = false ) {
		...
		return apply_filters( 'bp_group_leave_confirm_link', nxt_nonce_url( bp_get_group_permalink( $group ) . 'leave-group/yes', 'groups_leave_group' ) );
	}
	...
	function bp_get_group_join_button( $group = false ) {
		...
		if ( $group->is_member ) {
			...
			$button = array(
				...
				'link_href'         => nxt_nonce_url( bp_get_group_permalink( $group ) . 'leave-group', 'groups_leave_group' ),
			...
			switch ( $group->status ) {
				...
				case 'public':
					$button = array(
						...
						'wrapper_class'     => 'group-button ' . $group->status,
						'wrapper_id'        => 'groupbutton-' . $group->id,
						'link_href'         => nxt_nonce_url( bp_get_group_permalink( $group ) . 'join', 'groups_join_group' ),
				...
				case 'private' :
					...
					if ( !bp_group_has_requested_membership( $group ) ) {
						$button = array(
							...
							'wrapper_class'     => 'group-button ' . $group->status,
							'wrapper_id'        => 'groupbutton-' . $group->id,
							'link_href'         => nxt_nonce_url( bp_get_group_permalink( $group ) . 'request-membership', 'groups_request_membership' ),
...
function bp_group_member_pagination() {
	...
	nxt_nonce_field( 'bp_groups_member_list', '_member_pag_nonce' );
}
...
function bp_group_avatar_delete_link() {
	...
	function bp_get_group_avatar_delete_link() {
		...
		return apply_filters( 'bp_get_group_avatar_delete_link', nxt_nonce_url( bp_get_group_permalink( $bp->groups->current_group ) . '/admin/group-avatar/delete', 'bp_group_avatar_delete' ) );
	}
...
function bp_group_request_reject_link() {
	...
	function bp_get_group_request_reject_link() {
		...
		return apply_filters( 'bp_get_group_request_reject_link', nxt_nonce_url( bp_get_group_permalink( $groups_template->group ) . '/admin/membership-requests/reject/' . $requests_template->request->id, 'groups_reject_membership_request' ) );
	}
...
function bp_group_request_accept_link() {
	...
	function bp_get_group_request_accept_link() {
		...
		return apply_filters( 'bp_get_group_request_accept_link', nxt_nonce_url( bp_get_group_permalink( $groups_template->group ) . '/admin/membership-requests/accept/' . $requests_template->request->id, 'groups_accept_membership_request' ) );
	}
...
function bp_group_invite_user_remove_invite_url() {
	...
	function bp_get_group_invite_user_remove_invite_url() {
		...
		return nxt_nonce_url( site_url( bp_get_groups_slug() . '/' . $invites_template->invite->group_id . '/invites/remove/' . $invites_template->invite->user->id ), 'groups_invite_uninvite_user' );
	}

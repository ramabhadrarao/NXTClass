...
function bp_blogs_subdomain_base() {
	 ...
	 * a subdomain installation of NXTClass MS
	 *
	 * @since 1.6
...
function bp_blogs_confirm_blog_signup( $domain, $path, $blog_title, $user_name, $user_email = '', $meta = '' ) {
	...
	<p>
		<?php printf(__( '<a href="%1$s">%2$s</a> is your new site.  <a href="%3$s">Login</a> as "%4$s" using your existing password.', 'buddypress' ), $blog_url, $blog_url, $blog_url . "nxt-login.php", $user_name ); ?>
	</p>

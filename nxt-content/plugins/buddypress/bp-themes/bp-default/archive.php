<?php get_header(); ?>
	...
	<div id="content">
		...
		<div class="page" id="blog-archives" role="main">
			...
			<h3 class="pagetitle"><?php printf( __( 'You are browsing the archive for %1$s.', 'buddypress' ), nxt_title( false, false ) ); ?></h3>
					...
					<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<div class="post-content">
							...
							<div class="entry">
								...
								<?php nxt_link_pages( array( 'before' => '<div class="page-link"><p>' . __( 'Pages: ', 'buddypress' ), 'after' => '</p></div>', 'next_or_number' => 'number' ) ); ?>
							</div>

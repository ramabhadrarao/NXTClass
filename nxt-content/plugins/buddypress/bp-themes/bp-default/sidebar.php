...
<div id="sidebar" role="complementary">
	...
	<?php if ( is_user_logged_in() ) : ?>
		...
		<div id="sidebar-me">
			...
			<a class="button logout" href="<?php echo nxt_logout_url( bp_get_root_domain() ) ?>"><?php _e( 'Log Out', 'buddypress' ) ?></a>
	...
	<?php else : ?>
		...
		<form name="login-form" id="sidebar-login-form" class="standard-form" action="<?php echo site_url( 'nxt-login.php', 'login_post' ) ?>" method="post">
			...
			<input type="submit" name="nxt-submit" id="sidebar-nxt-submit" value="<?php _e( 'Log In', 'buddypress' ); ?>" tabindex="100" />

	...
	jQuery("a.ajax-option-delete").click(
		function() {
			...
			jQuery.post( ajaxurl, {
				...
				'_nxtnonce': jQuery("input#_nxtnonce").val(),
	...
	jQuery( "ul#field-group-tabs" ).sortable( {
		...
		update: function() {
			jQuery.post( ajaxurl, {
				...
				'cookie': encodeURIComponent(document.cookie),
				'_nxtnonce_reorder_groups': jQuery( "input#_nxtnonce_reorder_groups" ).val(),
	...
	jQuery( "fieldset.field-group" ).sortable({
		...
		update: function() {
			jQuery.post( ajaxurl, {
				...
				'cookie': encodeURIComponent(document.cookie),
				'_nxtnonce_reorder_fields': jQuery( "input#_nxtnonce_reorder_fields" ).val(),

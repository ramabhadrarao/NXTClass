...
add_filter( 'bp_get_the_profile_group_name',          'nxt_filter_kses',       1 );
add_filter( 'bp_get_the_profile_group_description',   'nxt_filter_kses',       1 );
add_filter( 'bp_get_the_profile_field_value',         'xprofile_filter_kses', 1 );
add_filter( 'bp_get_the_profile_field_name',          'nxt_filter_kses',       1 );
add_filter( 'bp_get_the_profile_field_edit_value',    'nxt_filter_kses',       1 );
add_filter( 'bp_get_the_profile_field_description',   'nxt_filter_kses',       1 );

add_filter( 'bp_get_the_profile_field_value',         'nxttexturize'        );
add_filter( 'bp_get_the_profile_field_value',         'convert_smilies', 2 );
add_filter( 'bp_get_the_profile_field_value',         'convert_chars'      );
add_filter( 'bp_get_the_profile_field_value',         'nxtautop'            );
...
add_filter( 'xprofile_get_field_data',                'nxt_filter_kses', 1 );
add_filter( 'xprofile_field_name_before_save',        'nxt_filter_kses', 1 );
add_filter( 'xprofile_field_description_before_save', 'nxt_filter_kses', 1 );

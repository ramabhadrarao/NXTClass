...
?>
	...
	<div class="wrap">
		...
		<form action="" id="profile-field-form" method="post">
			...
			<?php nxt_nonce_field( 'bp_reorder_fields', '_nxtnonce_reorder_fields' ); ?>

			<?php nxt_nonce_field( 'bp_reorder_groups', '_nxtnonce_reorder_groups', false );
...
function xprofile_ajax_reorder_fields() {
	...
	// Check the nonce
	check_admin_referer( 'bp_reorder_fields', '_nxtnonce_reorder_fields' );
...
add_action( 'nxt_ajax_xprofile_reorder_fields', 'xprofile_ajax_reorder_fields' );
...
function xprofile_ajax_reorder_field_groups() {
	...
	// Check the nonce
	check_admin_referer( 'bp_reorder_groups', '_nxtnonce_reorder_groups' );
...
add_action( 'nxt_ajax_xprofile_reorder_groups', 'xprofile_ajax_reorder_field_groups' );

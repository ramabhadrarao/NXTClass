<?php
/*****
 * NXTClass Abstraction
 *
 * The functions within this file will detect the version of NXTClass you are running
 ...
 * the 3.0 NXTClass version merge takes place.
 */
...
/**
 * Parso the NXTClass core version number into the major release
 *
...
/**
 * Only add abstraction functions if NXTClass is not in multisite mode
 */
if ( !is_multisite() ) {
	global $nxtdb;

	$nxtdb->base_prefix = $nxtdb->prefix;
	$nxtdb->blogid      = BP_ROOT_BLOG;

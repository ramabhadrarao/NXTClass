...
function bp_core_fetch_avatar_filter( $avatar, $user, $size, $default, $alt = '' ) {
	...
	// Do not filter if inside NXTClass options page
 ...
 *
 * Returns the absolute upload path for the nxt installation
 *
 * @uses nxt_upload_dir To get upload directory info
 * @return string Absolute path to nxt upload directory
 */

			...
			<table class="form-table">
				<tbody>
					...
					<?php if ( bp_is_active( 'xprofile' ) ) : ?>
						...
						<tr>
							<th scope="row"><?php _e( 'Disable BuddyPress to NXTClass profile syncing?', 'buddypress' ) ?></th>
							<td>
...
?>
	...
	<div class="wrap">
		...
		<form action="" method="post" id="bp-admin-component-form">
			...
			<?php nxt_nonce_field( 'bp-admin-component-setup' ); ?>
...
?>
	...
	<div class="wrap">
		...
		<form action="" method="post" id="bp-admin-page-form">
			...
			<?php nxt_nonce_field( 'bp-admin-pages-setup' ); ?>
...
function bp_core_admin_page_options() {
	...
	<p><?php _e( 'Associate a NXTClass Page with each BuddyPress component directory.', 'buddypress' ); ?></p>
			...
			<?php foreach ( $directory_pages as $name => $label ) : ?>
				...
				<tr valign="top">
					...
					<td>
						...
						<?php echo nxt_dropdown_pages( array(
	...
	<p><?php _e( 'Associate NXTClass Pages with the following BuddyPress Registration pages.', 'buddypress' ); ?></p>

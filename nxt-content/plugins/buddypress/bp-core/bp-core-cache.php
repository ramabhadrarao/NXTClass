...
/**
 * REQUIRES nxt-SUPER-CACHE
 *
 * When nxt-super-cache is installed this function will clear cached pages
...
function bp_core_add_global_group() {
	nxt_cache_init();
	nxt_cache_add_global_groups( array( 'bp' ) );
}
...
add_action( 'nxt_login',              'bp_core_clear_cache' );

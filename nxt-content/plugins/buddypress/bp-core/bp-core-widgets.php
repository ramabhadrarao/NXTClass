...
class BP_Core_Members_Widget extends nxt_Widget {
	...
	function widget( $args, $instance ) {
		...
		<?php if ( bp_has_members( 'user_id=0&type=' . $instance['member_default'] . '&max=' . $instance['max_members'] . '&populate_extras=0' ) ) : ?>
			...
			<?php nxt_nonce_field( 'bp_core_widget_members', '_nxtnonce-members' ); ?>
...
class BP_Core_Whos_Online_Widget extends nxt_Widget {
...
class BP_Core_Recently_Active_Widget extends nxt_Widget {
...
add_action( 'nxt_ajax_widget_members', 'bp_core_ajax_widget_members' );

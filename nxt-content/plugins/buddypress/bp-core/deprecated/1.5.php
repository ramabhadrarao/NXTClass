 ...
 *
 * This function originally served as a wrapper when NXTClass and NXTClass MU were separate entities.
...
/**
 * nxtMU version of is_super_admin()
 *
 * @deprecated 1.5
...
function bp_core_get_nxt_profile() {
...
function bp_dtheme_deprecated() {
	if ( !function_exists( 'bp_dtheme_nxt_pages_filter' ) ) :
	/**
	 ...
	 * @return string
	 * @see nxt_dropdown_pages()
	 * @since 1.2
	 */
	function bp_dtheme_nxt_pages_filter( $page_html ) {
		_deprecated_function( __FUNCTION__, '1.5', "No longer required." );
		return $page_html;
	}
	endif;
	 ...
	 * @deprecated 1.5
	 * @deprecated No longer required.
	 * @param array $posts Posts as retrieved by nxt_Query
	 * @return array
	 * @since 1.2.5
	 */

...
add_action( 'nxt_head', 'bp_core_confirmation_js', 100 );
 ...
 *
 * Adds AJAX target URL so themes can access the NXTClass AJAX functionality.
 *
 * @package BuddyPress Core
 */
...
?>
	...
	<script type="text/javascript">var ajaxurl = "<?php echo site_url( 'nxt-load.php' ); ?>";</script>

<?php
}
add_action( 'nxt_head', 'bp_core_add_ajax_url_js' );

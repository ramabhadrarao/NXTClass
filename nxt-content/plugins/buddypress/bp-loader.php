...
if ( file_exists( nxt_PLUGIN_DIR . '/bp-custom.php' ) )
	require( nxt_PLUGIN_DIR . '/bp-custom.php' );
...
function bp_loader_activate() {
	...
	if ( !function_exists( 'get_blog_option' ) )
		require ( nxt_PLUGIN_DIR . '/buddypress/bp-core/bp-core-nxtabstraction.php' );

	if ( !function_exists( 'bp_get_root_blog_id' ) )
		require ( nxt_PLUGIN_DIR . '/buddypress/bp-core/bp-core-functions.php' );

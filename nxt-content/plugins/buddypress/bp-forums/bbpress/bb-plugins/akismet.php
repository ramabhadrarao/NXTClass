...
Description: Akismet checks posts against the Akismet web service to see if they look like spam or not. You need a <a href="http://nxtclass.com/api-keys/">NXTClass.com API key</a> to use this service.
...
<?php
	...
	bb_option_form_element( 'akismet_key', array(
		'title' => __( 'NXTClass.com API Key' ),
		'attributes' => array( 'maxlength' => 12 ),
		'after' => $after,
		'note' => sprintf( __( 'If you don\'t have a NXTClass.com API Key, you can get one at <a href="%s">NXTClass.com</a>' ), 'http://nxtclass.com/api-keys/' )
	) );

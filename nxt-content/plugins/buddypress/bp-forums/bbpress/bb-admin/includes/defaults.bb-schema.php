...
if ( bb_get_option( 'nxt_table_prefix' ) || ( defined( 'BB_SCHEMA_IGNORE_nxt_USERS_TABLES' ) && BB_SCHEMA_IGNORE_nxt_USERS_TABLES ) ) {
	...
	// users - 'user_login', 'user_nicename' and 'user_registered' indices are inconsistent with NXTClass
...
// These elements in the schema may need to be ignored when doing comparisons due to inconsistencies with NXTClass
if ( bb_get_option('nxt_table_prefix') || ( defined( 'BB_SCHEMA_IGNORE_nxt_USERS_KEYS' ) && BB_SCHEMA_IGNORE_nxt_USERS_KEYS ) ) {

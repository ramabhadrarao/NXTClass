...
$time_options = array(
	...
	'datetime_format' => array(
		...
		'note' => array(
			__( '<a href="http://codex.nxtclass.org/Formatting_Date_and_Time">Documentation on date formatting</a>.' ),
...
if ( nxt_timezone_supported() ) {
	...
	$_time_options = array(
		'timezone_string' => array(
			'title' => __( 'Time zone' ),
			'type' => 'select',
			'options' => nxt_timezone_choice( $timezone_string ), // This passes a string of html, which gets used verbatim
			'note' => array(

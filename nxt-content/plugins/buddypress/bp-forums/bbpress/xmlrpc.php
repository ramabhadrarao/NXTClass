...
class BB_XMLRPC_Server extends IXR_Server
{
	 ...
	 * <methodCall>
	 *     <methodName>bb.nenxtost</methodName>
	 *     <params>
	 *         <param><value><string>joeblow</string></value></param>
	 *         <param><value><string>123password</string></value></param>
	 *         <param><value><struct>
	 ...
	 * </methodCall>
	 */
	function bb_nenxtost( $args )
	{
		do_action( 'bb_xmlrpc_call', 'bb.nenxtost' );
		...
		do_action( 'bb_xmlrpc_call_authenticated', 'bb.nenxtost' );
		...
		do_action( 'bb_xmlrpc_call_return', 'bb.nenxtost' );
	...
	function bb_getTopicTagCount( $args )
	{
		...
		if ( $topic_id ) {
			...
			global $nxt_taxonomy_object;
			$count = $nxt_taxonomy_object->count_terms( 'bb_topic_tag' );
			if ( is_nxt_error( $count ) ) {

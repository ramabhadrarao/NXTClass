 ...
 *
 * These classes were refactored from the NXTClass nxt_Scripts and NXTClass
 * script enqueue API.
 *
 * @package BackPress
 * @since r74
 ...
 *
 * @package BackPress
 * @uses _nxt_Dependency
 * @since r74
 */
class nxt_Dependencies {
	...
	function add( $handle, $src, $deps = array(), $ver = false, $args = null ) {
		if ( isset($this->registered[$handle]) )
			return false;
		$this->registered[$handle] = new _nxt_Dependency( $handle, $src, $deps, $ver, $args );
		return true;
	}

 ...
 * and transients but not rely on the NXTClass options API.
 *
 * @since r132
 */
...
interface BP_Options_Interface
{
	 ...
	 * - nxt_http_version    : This is the version sent when making remote HTTP requests
	 * - hash_function_name : The function used to create unique hashes ( see nxt_hash() )

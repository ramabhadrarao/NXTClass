...
{
	var $db; // BBPDB object
	var $users; // nxt_Users object

	var $cookies;

	var $current = 0;

	function nxt_Auth( &$db, &$users, $cookies )
	{
	 ...
	 *
	 * Some NXTClass functionality is based on the current user and
	...
	function set_current_user( $user_id )
	{
		...
		// nxt add_action( 'set_current_user', 'setup_userdata', 1 );

...
{
	// NXTClass would need to be initialised with this:
	// nxt_cache_add_global_groups( array( 'users', 'userlogins', 'usermeta', 'site-options', 'site-lookup', 'blog-lookup', 'blog-details', 'rss' ) );
	var $global_groups = array (
		'_cache_keys'
	);

	// NXTClass would need to be initialised with this:
	// nxt_cache_add_non_persistent_groups( array( 'comment', 'counts' ) );

...
/**
 * From nxt nxt-includes/formatting.php
 *
...
if ( !function_exists( 'nxttexturize' ) ) :
/**
...
function nxttexturize($text) {
	...
	for ( $i = 0; $i < $stop; $i++ ) {
		...
		if ( !empty($curl) && '<' != $curl{0} && '[' != $curl{0}
			...
			/*
			 * Only call _nxttexturize_pushpop_element if first char is correct
			 * tag opening
			 */
			if ('<' == $curl{0})
...
if ( !function_exists( '_nxttexturize_pushpop_element' ) ) :
/**
...
if ( !function_exists('_nxt_specialchars') ) :
/**
...
if ( !function_exists( 'nxt_specialchars_decode' ) ) :
/**
...
if ( !function_exists( 'nxt_check_invalid_utf8' ) ) :
/**
...
// ! function nxt_rel_nofollow()
// ! function nxt_rel_nofollow_callback()
...
// ! function nxt_trim_excerpt()

if ( !function_exists( 'ent2ncr' ) ) : // Current at [nxt9840]
/**
...
// ! function nxt_richedit_pre()
// ! function nxt_htmledit_pre()
...
if ( !function_exists( 'nxt_specialchars' ) ) :
/**
 * Escaping for HTML blocks
 * @deprecated 2.8.0
 * @see esc_html()
 */
function nxt_specialchars( $string, $quote_style = ENT_NOQUOTES, $charset = false, $double_encode = false ) {
	if ( func_num_args() > 1 ) { // Maintain backwards compat for people passing additional args
		$args = func_get_args();
		return call_user_func_array( '_nxt_specialchars', $args );
	} else {
...
// ! function nxt_make_link_relative()
// ! function sanitize_option()

if ( !function_exists('nxt_parse_str') ) :
/**
...
if ( !function_exists('nxt_pre_kses_less_than') ) :
/**
...
if ( !function_exists('nxt_pre_kses_less_than_callback') ) :
/**
...
// ! function nxt_sprintf()
// ! function nxt_sprintf_l()

if ( !function_exists('nxt_html_excerpt') ) :
/**
...
if ( !function_exists('nxt_strip_all_tags') ) :
/**

...
/**
 * From nxt nxt-includes/functions.php
 *
...
// ! function get_option()
// ! function nxt_protect_special_option()
...
// ! function nxt_set_all_user_settings()
...
// ! function do_enclose()
// ! function nxt_get_http()
// ! function nxt_get_http_headers()
// ! function is_new_day()
...
if ( !function_exists( 'nxt_remote_fopen' ) ) :
/**
...
if ( !function_exists( 'nxt_get_nocache_headers' ) ) :
/**
...
// ! function nxt_nonce_url()
// ! function nxt_nonce_field()

if ( !function_exists( 'nxt_referer_field' ) ) :
/**
...
if ( !function_exists( 'nxt_original_referer_field' ) ) :
/**
...
if ( !function_exists( 'nxt_get_referer' ) ) :
/**
 * Retrieve referer from '_nxt_http_referer', HTTP referer, or current page respectively.
 *
 * @package NXTClass
 * @subpackage Security
 * @since 2.0.4
...
if ( !function_exists( 'nxt_get_original_referer' ) ) :
/**
...
// ! function nxt_mkdir_p()
// ! function path_is_absolute()
// ! function path_join()
// ! function nxt_upload_dir()
// ! function nxt_unique_filename()
// ! function nxt_upload_bits()
// ! function nxt_ext2type()
// ! function nxt_check_filetype()
// ! function nxt_explain_nonce()
// ! function nxt_nonce_ays()
// ! function nxt_die()
// ! function _config_nxt_home()
// ! function _config_nxt_siteurl()
// ! function _mce_set_direction()
// ! function smilies_init()

if ( !function_exists('nxt_parse_args') ) :
/**
...
// ! function nxt_suspend_cache_invalidation()
// ! function get_site_option()
// ! function add_site_option()
// ! function update_site_option()

if ( !function_exists('nxt_timezone_override_offset') ) :
/**
...
if ( !function_exists('nxt_timezone_supported') ) :
/**
...
if ( !function_exists('_nxt_timezone_choice_usort_callback') ) :
...
if ( !function_exists('nxt_timezone_choice') ) :
/**
...
/**
 * From nxt nxt-settings.php
 */

if ( !function_exists( 'nxt_clone' ) ) :
/**
 * Copy an object.
 *

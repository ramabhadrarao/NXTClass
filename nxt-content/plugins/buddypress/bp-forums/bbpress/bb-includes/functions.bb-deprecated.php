...
function bb_parse_args( $args, $defaults = '' ) {
	bb_log_deprecated('function', __FUNCTION__, 'nxt_parse_args');
...
function bb_enqueue_script( $handle, $src = false, $deps = array(), $ver = false ) {
	bb_log_deprecated('function', __FUNCTION__, 'nxt_enqueue_script');
	nxt_enqueue_script( $handle, $src, $deps, $ver );
}
...
if ( !function_exists( 'paginate_links' ) ) : // Deprecated in bbPress not NXTClass
...
if ( !function_exists('nxt_clear_auth_cookie') ) : // Deprecated in bbPress not NXTClass
...
if ( !function_exists( 'nxt_validate_auth_cookie' ) ) : // Deprecated in bbPress not NXTClass
...
if ( !function_exists( 'nxt_set_auth_cookie' ) ) : // Deprecated in bbPress not NXTClass
...
if ( !function_exists( 'nxt_salt' ) ) : // Deprecated in bbPress not NXTClass
...
if ( !function_exists( 'nxt_hash' ) ) : // Deprecated in bbPress not NXTClass
...
if ( !function_exists( 'nxt_hash_password' ) ) : // Deprecated in bbPress not NXTClass
...
if ( !function_exists( 'nxt_check_password') ) : // Deprecated in bbPress not NXTClass
...
if ( !function_exists( 'nxt_generate_password' ) ) : // Deprecated in bbPress not NXTClass
...
if ( !class_exists( 'nxt_User' ) ) : // Deprecated in BackPress not NXTClass
class nxt_User extends BP_User {

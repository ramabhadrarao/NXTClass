...
add_filter('edit_text', 'nxt_specialchars');
...
add_action('bb_head', 'nxt_print_scripts');
add_action('bb_head', 'nxt_print_styles');
...
add_action('bb_admin_print_scripts', 'nxt_print_scripts');
...
add_action( 'set_current_user', 'bb_apply_nxt_role_map_to_user' );

add_filter( 'bb_pre_get_option_gmt_offset', 'nxt_timezone_override_offset' );

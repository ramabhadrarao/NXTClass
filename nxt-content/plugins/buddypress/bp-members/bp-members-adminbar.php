 ...
 *
 * Handles the member functions related to the NXTClass Admin Bar
 *
 * @package BuddyPress
 * @subpackage Core
 */
...
function bp_members_admin_bar_my_account_menu() {
	global $bp, $nxt_admin_bar, $nxt_version;
...
function bp_members_admin_bar_user_admin_menu() {
	...
	if ( !bp_core_is_user_spammer( bp_displayed_user_id() ) ) {
		$nxt_admin_bar->add_menu( array(
			...
			'href'   => nxt_nonce_url( bp_displayed_user_domain() . 'admin/mark-spammer/', 'mark-unmark-spammer' ),
		...
		$nxt_admin_bar->add_menu( array(
			...
			'href'   => nxt_nonce_url( bp_displayed_user_domain() . 'admin/unmark-spammer/', 'mark-unmark-spammer' ),
	...
	$nxt_admin_bar->add_menu( array(
		...
		'href'   => nxt_nonce_url( bp_displayed_user_domain() . 'admin/delete-user/', 'delete-user' ),

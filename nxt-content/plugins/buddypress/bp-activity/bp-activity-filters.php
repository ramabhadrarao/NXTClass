...
add_filter( 'bp_get_activity_action',                'nxttexturize' );
add_filter( 'bp_get_activity_content_body',          'nxttexturize' );
add_filter( 'bp_get_activity_content',               'nxttexturize' );
add_filter( 'bp_get_activity_parent_content',        'nxttexturize' );
add_filter( 'bp_get_activity_latest_update',         'nxttexturize' );
add_filter( 'bp_get_activity_latest_update_excerpt', 'nxttexturize' );
...
add_filter( 'bp_get_activity_action',                'nxtautop' );
add_filter( 'bp_get_activity_content_body',          'nxtautop' );
add_filter( 'bp_get_activity_content',               'nxtautop' );
add_filter( 'bp_get_activity_feed_item_description', 'nxtautop' );

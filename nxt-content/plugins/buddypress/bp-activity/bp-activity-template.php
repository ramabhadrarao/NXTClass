...
function bp_activity_favorite_link() {
	...
	function bp_get_activity_favorite_link() {
		global $bp, $activities_template;
		return apply_filters( 'bp_get_activity_favorite_link', nxt_nonce_url( home_url( bp_get_activity_root_slug() . '/favorite/' . $activities_template->activity->id . '/' ), 'mark_favorite' ) );
	}
...
function bp_activity_unfavorite_link() {
	...
	function bp_get_activity_unfavorite_link() {
		global $bp, $activities_template;
		return apply_filters( 'bp_get_activity_unfavorite_link', nxt_nonce_url( home_url( bp_get_activity_root_slug() . '/unfavorite/' . $activities_template->activity->id . '/' ), 'unmark_favorite' ) );
	}
